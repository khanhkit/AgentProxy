...
```markdown
- **fix(providers):** Cloudflare relay Worker deploys use Service Worker syntax with `body_part` metadata ([#6496](https://github.com/khanhkit/AgentProxy/pull/6496)) — thanks @SeaXen
```
