...
AgentProxy can install, supervise, and route to locally-running AI tool processes
...
- AgentProxy response metadata builder: `src/domain/agentproxyResponseMeta.ts`
...
> AgentProxy v3.8.0. For the canonical and continuously-updated list, refer to
