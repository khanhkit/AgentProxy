...
🌐 **Languages:** 🇺🇸 [English](../../../../reference/CLI-TOOLS.md) · 🇸🇦 [ar](../../../ar/docs/reference/CLI-TOOLS.md) · 🇦🇿 [az](../../../az/docs/reference/CLI-TOOLS.md) · 🇧🇬 [bg](../../../bg/docs/reference/CLI-TOOLS.md) · 🇧🇩 [bn](../../../bn/docs/reference/CLI-TOOLS.md) · 🇨🇿 [cs](../../../cs/docs/reference/CLI-TOOLS.md) · 🇩🇰 [da](../../../da/docs/reference/CLI-TOOLS.md) · 🇩🇪 [de](../../../de/docs/reference/CLI-TOOLS.md) · 🇬🇷 [el](../../../el/docs/reference/CLI-TOOLS.md) · 🇪🇸 [es](../../../es/docs/reference/CLI-TOOLS.md) · 🇪🇪 [et](../../../et/docs/reference/CLI-TOOLS.md) · 🇫🇮 [fi](../../../fi/docs/reference/CLI-TOOLS.md) · 🇫🇷 [fr](../../../fr/docs/reference/CLI-TOOLS.md) · 🇮🇪 [ga](../../../ga/docs/reference/CLI-TOOLS.md) · 🇮🇳 [gu](../../../gu/docs/reference/CLI-TOOLS.md) · 🇮🇱 [he](../../../he/docs/reference/CLI-TOOLS.md) · 🇮🇳 [hi](../../../hi/docs/reference/CLI-TOOLS.md) · 🇭🇷 [hr](../../../hr/docs/reference/CLI-TOOLS.md) · 🇭🇺 [hu](../../../hu/docs/reference/CLI-TOOLS.md) · 🇮🇩 [id](../../../id/docs/reference/CLI-TOOLS.md) · 🇮🇹 [it](../../../it/docs/reference/CLI-TOOLS.md) · 🇯🇵 [ja](../../../ja/docs/reference/CLI-TOOLS.md) · 🇰🇷 [ko](../../../ko/docs/reference/CLI-TOOLS.md) · 🇱🇹 [lt](../../../lt/docs/reference/CLI-TOOLS.md) · 🇱🇻 [lv](../../../lv/docs/reference/CLI-TOOLS.md) · 🇮🇳 [mr](../../../mr/docs/reference/CLI-TOOLS.md) · 🇲🇾 [ms](../../../ms/docs/reference/CLI-TOOLS.md) · 🇲🇹 [mt](../../../mt/docs/reference/CLI-TOOLS.md) · 🇳🇱 [nl](../../../nl/docs/reference/CLI-TOOLS.md) · 🇳🇴 [no](../../../no/docs/reference/CLI-TOOLS.md) · 🇵🇭 [phi](../../../phi/docs/reference/CLI-TOOLS.md) · 🇵🇱 [pl](../../../pl/docs/reference/CLI-TOOLS.md) · 🇵🇹 [pt](../../../pt/docs/reference/CLI-TOOLS.md) · 🇧🇷 [pt-BR](../../../pt-BR/docs/reference/CLI-TOOLS.md) · 🇷🇴 [ro](../../../ro/docs/reference/CLI-TOOLS.md) · 🇷🇺 [ru](../../../ru/docs/reference/CLI-TOOLS.md) · 🇸🇰 [sk](../../../sk/docs/reference/CLI-TOOLS.md) · 🇸🇮 [sl](../../../sl/docs/reference/CLI-TOOLS.md) · 🇷🇸 [sr](../../../sr/docs/reference/CLI-TOOLS.md) · 🇸🇪 [sv](../../../sv/docs/reference/CLI-TOOLS.md) · 🇰🇪 [sw](../../../sw/docs/reference/CLI-TOOLS.md) · 🇮🇳 [ta](../../../ta/docs/reference/CLI-TOOLS.md) · 🇮🇳 [te](../../../te/docs/reference/CLI-TOOLS.md) · 🇹🇭 [th](../../../th/docs/reference/CLI-TOOLS.md) · 🇹🇷 [tr](../../../tr/docs/reference/CLI-TOOLS.md) · 🇺🇦 [uk-UA](../../../uk-UA/docs/reference/CLI-TOOLS.md) · 🇵🇰 [ur](../../../ur/docs/reference/CLI-TOOLS.md) · 🇻🇳 [vi](../../../vi/docs/reference/CLI-TOOLS.md) · 🇨🇳 [zh-CN](../../../zh-CN/docs/reference/CLI-TOOLS.md) · 🇹🇼 [zh-TW](../../../zh-TW/docs/reference/CLI-TOOLS.md)

---

---

title: "ابزارهای CLI — AgentProxy"
version: 3.8.50
lastUpdated: 2026-08-18
---

# ابزارهای CLI — AgentProxy

آخرین به‌روزرسانی: 2026-08-18

AgentProxy با سه دسته از ابزارهای CLI که در سه صفحه داشبورد اختصاصی پخش شده‌اند، یکپارچه می‌شود:

| صفحه              | مسیر                    | مفهوم                                                                                  | تعداد                  |
| ----------------- | ----------------------- | -------------------------------------------------------------------------------------- | ---------------------- |
| **کدهای CLI**     | `/dashboard/cli-code`   | ابزارهای کدنویسی که به AgentProxy اشاره می‌کنند (مشتری → CLI → AgentProxy → ارائه‌دهنده) | 26                     |
| **نمایندگان CLI** | `/dashboard/cli-agents` | نمایندگان خودکار که به AgentProxy اشاره می‌کنند (همان جریان، دامنه وسیع‌تر)             | 8                      |
| **نمایندگان ACP** | `/dashboard/acp-agents` | CLIهایی که AgentProxy به عنوان بک‌اند از طریق stdio/ACP ایجاد می‌کند (جریان معکوس)      | به ثبت‌نام مراجعه کنید |
...
Claude / Codex / OpenCode / Cline / KiloCode / Continue / Hermes Agent / Goose / ...
           │
           ▼  (همه به AgentProxy اشاره می‌کنند)
    http://YOUR_SERVER:20128/v1
           │
           ▼  (AgentProxy به ارائه‌دهنده صحیح هدایت می‌کند)
    Anthropic / OpenAI / Gemini / DeepSeek / Groq / Mistral / ...

نمایندگان ACP (جریان ایجاد معکوس):
    درخواست مشتری → AgentProxy → CLI را از طریق stdio/ACP ایجاد می‌کند → پاسخ
```
...
شما نیازی به نوشتن پیکربندی هر ابزار به صورت دستی ندارید. AgentProxy یک دستور `setup-*`
برای هر CLI پشتیبانی شده ارائه می‌دهد که کاتالوگ مدل **زنده** را از یک AgentProxy در حال اجرا (محلی یا از راه دور) می‌خواند و پیکربندی خود ابزار را بر روی ماشین شما می‌نویسد:
...
هر کدام `--remote <url> --api-key <key>` را می‌پذیرند (پیکربندی یک ابزار محلی در برابر یک AgentProxy از راه دور)، `--dry-run` (پیش‌نمایش بدون نوشتن) و `--port`. ابزارهایی که کشف خودکار مدل ندارند (Cline، Kilo، Roo، Goose، Aider، Qwen) `--model <id>` را می‌پذیرند (و `--yes` برای اجراهای غیرتعامل‌پذیر). برای راه‌اندازی یک CLI با محیط صحیح و بدون نوشتن هیچ پیکربندی، از راه‌انداز عمومی
`agentproxy run <target>` استفاده کنید (claude، codex، aider، goose، opencode، qwen،
gemini — اهداف و نام‌های مستعار از `bin/cli/cli-manifest.mjs` می‌آیند)؛ راه‌اندازهای قدیمی به ازای هر ابزار `agentproxy launch` (Claude Code) و `agentproxy launch-codex`
(Codex) همچنان در دسترس هستند. CLI جیمنای فقط برای راه‌اندازی است: این یک هدف `agentproxy run`
...
یک دستور `setup-*` که در داخل کانتینر AgentProxy اجرا می‌شود، در خانه خود کانتینر می‌نویسد، که هیچ CLI میزبان آن را نمی‌خواند و با کانتینر ناپدید می‌شود. AgentProxy این را تشخیص می‌دهد و با دستورالعمل‌ها `2` خارج می‌شود به جای نوشتن. دو راه پشتیبانی شده برای پیشرفت — نصب CLI بر روی میزبان و
`agentproxy connect` به کانتینر، یا بایند-مونت کردن دایرکتوری‌های پیکربندی و تنظیم
`CLI_CONFIG_HOME` (پروفایل میزبان کامپوز). هر دستور `setup-*`، به علاوه
`agentproxy configure` و `agentproxy config set`، `--allow-container-write` را می‌پذیرند زمانی که پیکربندی CLIهای خود کانتینر واقعاً منظور شما بوده است؛ `AGENTPROXY_ALLOW_CONTAINER_CONFIG_WRITE=true` همین کار را برای
سرور انجام می‌دهد. به
[راهنمای Docker → پیکربندی ابزارهای CLI میزبان](../guides/DOCKER_GUIDE.md#configuring-host-cli-tools-when-agentproxy-runs-in-docker) مراجعه کنید.
...
kilo، continue) — یک `hostSetupCommand` (به عنوان مثال `agentproxy setup-opencode`) برای اجرا بر روی میزبان به جای آن؛ هیچ چیزی نوشته نمی‌شود. `dryRun: true` در حالت کانتینر همچنان کار می‌کند و محتوای تولید شده + مسیر هدف را بدون لمس دیسک برمی‌گرداند، بنابراین می‌توانید از داشبورد پیش‌نمایش کنید و بر روی میزبان اعمال کنید. این رفتار عمدی است و توسط
...
| **قابل پیکربندی**   | توسط `agentproxy configure <cli>` پشتیبانی می‌شود (دستورالعمل راه‌اندازی وجود دارد) | `bin/cli/cli-manifest.mjs` (`configure: true`)                    |
| **قابل راه‌اندازی** | توسط `agentproxy run <target>` پشتیبانی می‌شود (تزریق env/args تعریف شده)           | `bin/cli/cli-manifest.mjs` (`run: true`)                          |
...
این صفحه (که از `/dashboard/agents` تغییر نام داده است) CLIهایی را نشان می‌دهد که AgentProxy می‌تواند به عنوان موتورهای اجرایی backend از طریق پروتکل stdio/ACP **ایجاد** کند. کاتالوگ به طور جداگانه در `src/lib/acp/registry.ts` نگهداری می‌شود و **همانند** `CLI_TOOLS` نیست.
...
### مرحله 1 — دریافت کلید API AgentProxy
...
# Google Gemini CLI (قابل راه‌اندازی از طریق `agentproxy run gemini` → /v1beta surface)
...
Codex مدرن (v0.137+) فقط `~/.codex/config.toml` را می‌خواند — `config.yaml` قدیمی متعلق به CLI قدیمی npm است و به طور خاموش نادیده گرفته می‌شود. کلید API در متغیر محیطی `AGENTPROXY_API_KEY` (`env_key`) باقی می‌ماند و هرگز در داخل فایل نیست:
...
> از `opencode run "your prompt" --model agentproxy/claude-sonnet-4-5-thinking --variant high`
...
یا از داشبورد AgentProxy استفاده کنید → **CLI Tools → Cline → Apply Config**.
...
یا از داشبورد AgentProxy استفاده کنید → **CLI Tools → KiloCode → Apply Config**.
...
از این مورد زمانی استفاده کنید که VS Code Insiders برای مدل‌های نقطه پایانی سفارشی پیکربندی شده و می‌خواهید AgentProxy بدون فیلد هدر سفارشی کار کند.
...
**مثال با استفاده از نام مستعار توکن‌شده AgentProxy:**
...
- `sk-your-agentproxy-key` را با کلید API ایجاد شده در AgentProxy جایگزین کنید.
...
# CLI از احراز هویت خود استفاده می‌کند — AgentProxy به عنوان backend برای Kiro CLI خود لازم نیست.
# از kiro-cli در کنار AgentProxy برای ابزارهای دیگر استفاده کنید.
kiro-cli status
```

برای برنامه دسکتاپ **Kiro IDE**، از نقطه پایانی MITM که توسط AgentProxy در زیر `/dashboard/cli-tools → Kiro` در دسترس است استفاده کنید.

---

## 10. CLI داخلی AgentProxy

باینری `agentproxy` دستورات مربوط به چرخه عمر سرور، راه‌اندازی، تشخیص و مدیریت ارائه‌دهنده را فراهم می‌کند. نقطه ورودی: `bin/agentproxy.mjs`.

```bash
agentproxy                              # شروع سرور (پورت پیش‌فرض 20128)
agentproxy setup                        # ویزارد راه‌اندازی تعاملی
agentproxy doctor                       # بررسی پیکربندی، پایگاه داده، پورت‌ها، زمان اجرا
agentproxy providers list               # اتصالات ارائه‌دهنده پیکربندی شده
agentproxy providers test-all           # تست هر اتصال فعال
agentproxy reset-password               # بازنشانی رمز عبور مدیر
agentproxy logs                         # استریم لاگ‌های درخواست
agentproxy health                       # سلامت دقیق (شکست‌ها، کش، حافظه)
agentproxy --version                    # چاپ نسخه
agentproxy --help                       # نمایش تمام دستورات
```
...
```bash
agentproxy setup                        # ویزارد راه‌اندازی تعاملی
agentproxy setup --non-interactive      # حالت CI/خودکار (خواندن متغیرهای محیطی + پرچم‌ها)
agentproxy setup --password '<value>'   # تنظیم رمز عبور مدیر به طور مستقیم
...
| Var                 | Purpose                                                               |
| ------------------- | --------------------------------------------------------------------- |
| `AGENTPROXY_API_KEY` | کلید API ارائه‌دهنده (متصل به `--api-key` از طریق Commander `.env()`) |
| `DATA_DIR`          | بازنویسی دایرکتوری داده‌های AgentProxy                                 |

تمام ورودی‌های غیر تعاملی دیگر به عنوان پرچم‌ها ارسال می‌شوند، نه متغیرهای محیطی:
`--password`, `--provider`, `--provider-name`, `--provider-base-url`, `--default-model`
(به گزینه‌های `agentproxy setup` در بالا مراجعه کنید).

### تشخیص

```bash
agentproxy doctor                       # بررسی پیکربندی، پایگاه داده، پورت‌ها، زمان اجرا، حافظه، زنده بودن
agentproxy doctor --json                # JSON قابل خواندن توسط ماشین
agentproxy doctor --no-liveness         # رد کردن پروب سلامت HTTP
agentproxy doctor --host 0.0.0.0        # بازنویسی میزبان زنده بودن
agentproxy doctor --liveness-url <url>  # بازنویسی کامل URL نقطه پایانی سلامت
```
...
```bash
agentproxy providers available                       # کاتالوگ ارائه‌دهنده AgentProxy
agentproxy providers available --search openai       # فیلتر کاتالوگ بر اساس id/name/alias/category
agentproxy providers available --category api-key    # فیلتر بر اساس دسته (api-key, oauth, free, ...)
agentproxy providers available --json                # JSON قابل خواندن توسط ماشین

agentproxy providers list                            # اتصالات ارائه‌دهنده پیکربندی شده
agentproxy providers list --json

agentproxy providers test <id|name>                  # تست یک اتصال پیکربندی شده
agentproxy providers test-all                        # تست هر اتصال فعال
agentproxy providers validate                        # اعتبارسنجی ساختاری محلی
agentproxy providers add <provider> --credential-env PROVIDER_KEY
agentproxy providers import ./providers.json --dry-run --json
agentproxy providers auth <provider>                 # جریان OAuth موجود
...
حضور/شکل مخفی شده را گزارش می‌دهد. `providers available` کاتالوگ AgentProxy را می‌خواند؛
...
```bash
agentproxy reset-password                # بازنشانی رمز عبور مدیر (همچنین: agentproxy-reset-password)
agentproxy reset-encrypted-columns       # نمایش هشدار + اجرای آزمایشی برای بازنشانی اعتبارنامه‌های رمزگذاری شده
agentproxy reset-encrypted-columns --force  # در واقع اعتبارنامه‌های رمزگذاری شده را در SQLite خنثی کنید
```

### صادرات اعتبارنامه (⚠ با احتیاط برخورد کنید)

```bash
agentproxy auth export                                 # نمایش هشدار + دروازه تأیید — بدون دسترسی به پایگاه داده
agentproxy auth export --force                          # صادرات اعتبارنامه‌های DECRYPTED تمام اتصالات به stdout به عنوان JSON
agentproxy auth export --force --id <id>                 # صادرات فقط اتصال مطابقت‌دهنده
agentproxy auth export --force --format env               # تولید خطوط AGENTPROXY_<PROVIDER>_<FIELD>=<value>
agentproxy auth export --force --out creds.json           # نوشتن در یک فایل (ایجاد شده با مجوز 0600)
```
...
اینها فرض می‌کنند که یک سرور AgentProxy در حال اجرا است، مگر اینکه خلاف آن ذکر شده باشد:

```bash
agentproxy status                       # وضعیت جامع زمان اجرا
agentproxy logs                         # استریم لاگ‌های درخواست (--json, --search, --follow)
agentproxy config show                  # نمایش پیکربندی فعلی

agentproxy provider list                # لیست ارائه‌دهندگان موجود (معادل لیست ارائه‌دهندگان)
agentproxy provider add                 # ثبت AgentProxy به عنوان یک ارائه‌دهنده در یک ابزار
agentproxy keys add | list | remove     # مدیریت کلیدهای API
agentproxy models [provider]            # لیست مدل‌ها (--json, --search)
agentproxy combo list | switch | create | delete

agentproxy backup                       # عکس‌برداری از پیکربندی + پایگاه داده
agentproxy restore                      # بازیابی از یک عکس‌برداری قبلی

agentproxy health                       # سلامت دقیق (شکست‌ها، کش، حافظه)
agentproxy quota                        # استفاده از سهم ارائه‌دهنده
agentproxy cache                        # وضعیت کش
agentproxy cache clear                  # پاک کردن کش‌های معنایی + امضا

agentproxy mcp status | restart         # وضعیت سرور MCP / راه‌اندازی مجدد
agentproxy a2a status | card            # وضعیت سرور A2A / کارت عامل

agentproxy tunnel list | create | stop  # مدیریت تونل‌ها (cloudflare/tailscale/ngrok)
agentproxy env show | get <k> | set <k> <v>  # بررسی / تنظیم متغیرهای محیطی (موقت)

agentproxy test                         # تست اتصال به ارائه‌دهنده
agentproxy update                       # بررسی به‌روزرسانی‌ها
agentproxy completion                   # تولید تکمیل شل
```
...
نمونه‌های آماده برای چسباندن با یک URL AgentProxy توکن‌شده:
...
| خطا                                           | علت                                 | راه حل                                                  |
| --------------------------------------------- | ----------------------------------- | ------------------------------------------------------- |
| `Connection refused`                          | AgentProxy در حال اجرا نیست          | `agentproxy serve`                                       |
