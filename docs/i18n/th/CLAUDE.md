...
**AgentProxy** — โปรเซสเซอร์/เราเตอร์ AI ที่รวมเป็นหนึ่ง จุดสิ้นสุดเดียว, ผู้ให้บริการ LLM 329 ราย, การสำรองข้อมูลอัตโนมัติ
...
AgentProxy มีกลไกการล้มเหลวชั่วคราวที่เกี่ยวข้องกันสามอย่าง แต่แตกต่างกัน รักษาขอบเขตของพวกเขาแยกกันเมื่อทำการดีบักพฤติกรรมการจัดเส้นทาง ดู
...
- **การนำเข้า**: ภายนอก → ภายใน (`@/`, `@agentproxy/open-sse`) → เชิงสัมพันธ์
...
- **ไดเรกทอรีข้อมูล**: `DATA_DIR` env var, ค่าเริ่มต้นเป็น `~/.agentproxy/`
