...
⭐ Anna hoidlale täht, kui AGENTPROXY aitas sul raha säästa ja tööd lihtsamaks muuta.

</h3>

[![Tähed](https://img.shields.io/github/stars/khanhkit/AgentProxy?style=social)](https://github.com/khanhkit/AgentProxy)
...
[![Täheajaloo edetabelikoht](https://api.star-history.com/badge?repo=khanhkit/AgentProxy&theme=dark)](https://www.star-history.com/khanhkit/agentproxy)
...
[![Veebisait](https://img.shields.io/badge/Website-agentproxy.online-blue?logo=google-chrome&logoColor=white)](https://agentproxy.example.com)

**Küsimused, teenusepakkujate näpunäited, tegevuskava ja tugi → [Discord](https://discord.gg/U47eFqAXCn) · [Telegram](https://github.com/khanhkit/AgentProxy/discussions) · WhatsApp [🌍 ülemaailmne](https://chat.whatsapp.com/FvuCbrpZmQ6I85n2vW5QIC?s=cl&p=a&mlu=4) / [🇧🇷 Brasiilia](https://chat.whatsapp.com/KWgatljAjmbELQory59Oti?s=cl&p=a&mlu=4) / [portaal](https://portal.sthub.com.br/communities/groups/st-hub/channels/AgentProxy-World-8kRjmK)**

<br/>

## 📈 Lüüs kasvab aina edasi

<div align="center">

|                                  | v3.8.49 |        **v3.8.50**         | `v3.8.51+` |
| -------------------------------- | :-----: | :------------------------: | :--------: |
| 🌐 Teenusepakkujad               |   290   |          **352**           | veel ootel |
| 🧠 Unikaalsed vestlusmudeli ID-d |  1185   |          **1312**          |     —      |
| 🖼️ Modaalsuste sild              |    —    | 🆕 nägemine + heli + video |     —      |
| 📡 Radari tasuta kataloog        |    —    |       🆕 valikuline        |     —      |
...
[![npm-i versioon](https://img.shields.io/npm/v/agentproxy?color=cb3837&logo=npm)](https://www.npmjs.com/package/agentproxy)
![NPM-i igakuised allalaadimised](https://img.shields.io/npm/dm/agentproxy?label=npm/month&color=cb3837&logo=npm)
...
![Dockeri tõmbamised](https://img.shields.io/docker/pulls/khanhkit/agentproxy?label=docker%20pulls&logo=docker&color=2496ED)
![Electroni allalaadimised](https://img.shields.io/github/downloads/khanhkit/agentproxy/total?style=flat&label=electron%20downloads&logo=electron&color=47848F)

<table>
  <tr>
    <td align="right"><b>🚀 Alustamine</b></td>
    <td align="center"><a href="#-quick-start">🚀 Kiirstart</a></td>
    <td align="center"><a href="#-more-install-methods--docker-source-pnpm-arch">📦 Installimine</a></td>
    <td align="center"><a href="#-works-the-second-you-install-it--no-keys-no-config">🆓 Seadistamiseta</a></td>
  </tr>
  <tr>
    <td align="right"><b>💡 Õppimine</b></td>
    <td align="center"><a href="#-the-promise">💥 Lubadus</a></td>
    <td align="center"><a href="#-why-agentproxy">🤔 Miks AgentProxy</a></td>
    <td align="center"><a href="#-what-sets-agentproxy-apart">🏆 Mis seda eristab</a></td>
  </tr>
  <tr>
    <td align="right"><b>⚙️ Funktsioonid</b></td>
    <td align="center"><a href="#-combos--the-flagship">🎯 Kombod</a></td>
    <td align="center"><a href="#-352-ai-providers--154-catalog-marked-free">🌐 Teenusepakkujad</a></td>
    <td align="center"><a href="#-full-cli--a2a--mcp">🔌 CLI &amp; MCP</a></td>
  </tr>
  <tr>
    <td align="right"></td>
    <td align="center"><a href="#%EF%B8%8F-save-1595-tokens--automatically">🗜️ Tihendamine</a></td>
    <td align="center"><a href="#%EF%B8%8F-where-agentproxy-runs--anywhere">🖥️ Kus see töötab</a></td>
    <td align="center"><a href="#-private--local-first">🔒 Privaatne</a></td>
  </tr>
  <tr>
    <td align="right"><b>👀 Vaata</b></td>
    <td align="center"><a href="#-agentproxy-in-action">🎬 Töös</a></td>
  ...
  <tr>
    ...
    <td align="center"><a href="#-support-agentproxy">💚 Toeta / anneta</a></td>
...
<sub>Eelistad kindlat tasuta taustsüsteemi? Kutsu `oc/…` (OpenCode Free) otse. Seejärel liigu `auto` peale ja lase AgentProxy’il valida.</sub>
...
> **Soovid liituda avatud lähtekoodi sõbrana?** Need on ettevõtted, kes toetavad avatud lähtekoodi ja aitavad AgentProxy'i liikuma hoida — ja me avaldame avalikult, kuhu iga neilt saadud toke läheb. Võta ühendust: [diegosouza.pw@outlook.com](mailto:diegosouza.pw@outlook.com)
...
<table>
  <tr>
    ...
    <td>
      Tänud <b>Kimile (Moonshot AI)</b>, meie esimesele avatud lähtekoodi sõbrale, selle projekti toetamise eest! Kimi on AI-labor, mis on avatud kaaludega K2 ja K3 mudeliperede loojad — <b>Kimi K3</b> pakub 1M-tokenilist kontekstiakent, sisseehitatud nägemisvõimet ja tipptasemel koodikirjutamist murdosa hinnaga suletud mudelitest, ning töötab kohe kastist välja koos Claude Code'i, Codexi ja kõigi teiste koodivahenditega, mida AgentProxy teenindab.
      <br/><br/>
      <b>Mida Kimi toetus võimaldab:</b> Kimi API krediidid toidavad AgentProxy'i AI-valideeritud väljalaskeprotsessi — <i>Kimi K3 toega ühendamise valideerimist</i>, mis vaatab läbi iga pull request'i enne selle avaldamist — lisaks igapäevasele funktsioonide arendusele. Esmaklassiline Kimi tugi on olemas mõlemal teel: otsene <a href="https://platform.kimi.ai?track_id=track-8197581fdd7d4139a0f562e4a03c3798">Kimi API</a> (<code>kimi-k3</code>) ja <a href="https://www.kimi.com/code">Kimi Code koodiplaan</a> (OAuth ja API võti). AgentProxy on ka esimene brasiillik avatud lähtekoodi projekt Kimi toetusprogrammis. <a href="https://platform.kimi.ai?track_id=track-8197581fdd7d4139a0f562e4a03c3798"><b>Hangi Kimi API võti, millega saad 15% lisakrediiti →</b></a>
    </td>
  </tr>
  <tr>
    <td align="center" width="150">
    ...
    <td>
      Tänud <b>Cheaper Inference'ile</b>, AgentProxy'i avatud lähtekoodi sõbrale, selle projekti toetamise eest! Cheaper Inference on hinna järgi järjestatud vahendussüsteem, mis vahendab 42 tipptasemel mudelit — Claude, GPT-5.x, Gemini, Kimi K3, GLM, DeepSeek, Grok ja MiniMax — ühe OpenAI-ga ühilduva otspunkti tagant, suunates iga päringu odavaimale sobivale pakkujale, ilma et hind ületaks kunagi mudeli looja avaldatud hinnakirja.
      <br/><br/>
      <b>Esmaklassiline tugi AgentProxy'is:</b> Chat Completions, natiivne <code>/v1/responses</code> otspunkt, nägemine, tööriistade kutsumine ja 3 pildimudelit (<code>grok-imagine</code>, <code>nano-banana-pro</code>, <code>nano-banana-2</code>, kättesaadavad kui <code>cheaperinference/&lt;model&gt;</code>). <a href="https://cheaperinference.com/"><b>Hangi API võti →</b></a>
    </td>
  </tr>
</table>

<sub>Lingid tähisega <code>aff=agentproxy</code> on partnerlingid. Need rahastavad projekti, ilma et see sulle lisakulu tooks.</sub>
...
<sub><i>See jaotis on mõeldud ainult soovitus-/kupongikoodidele. Sponsoreeritud partnerlused on toodud eespool jaotises <b>🤝 Meie avatud lähtekoodi sõprade toel</b>. AgentProxy'il ei ole sponsorlust ega partnerlust siin loetletud pakkujatega — need on avalikud kupongid, mida igaüks saab kasutada.</i></sub>
...
<table>
  <tr>
    ...
    <td>
      <sub><b><a href="https://agentrouter.org/register?aff=70LM">AgentRouter</a></b> — partnerregistreerimine · <b>$100 tasuta krediiti</b> registreerumisel (tasuta server, arvesta suurema latentsusega — sobib parimini testimiseks, mitte tootmiseks). Esmaklassiline tugi AgentProxy'is alates versioonist <b>v3.8.50</b>: Chat Completions, Anthropicuga ühilduv edastusvorming ja OpenAI-ga ühilduv tee. Saadaval mudelite hulgas on <code>claude-opus-4-8</code>, <code>claude-opus-5</code>, <code>gpt-5.6-sol</code> ja teised. <b><a href="https://agentrouter.org/register?aff=70LM">Hangi oma $100 →</a></b></sub>
      <br/><br/>
      <sub>⚠️ <i>Partnerlink — AgentProxy'il ei ole sponsorlust ega partnerlust selle pakkujaga.</i></sub>
    </td>
  </tr>
</table>

<sub>Tead veel pakkujat, kellel on helde tasuta registreerimiskupong, mis oleks AgentProxy'i kasutajatele kasulik? Ava probleem (issue) ja me lisame selle siia.</sub>
...
> **Combo** on mudelite ahel, mille vahel AgentProxy suunab liiklust **automaatselt**. Kui kvoot saab otsa, teenusepakkuja tõrgub või kulud tõusevad hüppeliselt, saab combo liikuda järgmise sobiva ja töökorras mudeli juurde. 🛡️

### ⚡ Nullkonfiguratsiooniga — kasuta lihtsalt `auto`

Combo't ei pea looma. Sea mudeliks `auto` (või selle variant) ja AgentProxy loob sinu ühendatud teenusepakkujatest virtuaalse combo, mida hinnatakse jooksvalt:
...
<img src="./docs/diagrams/resilience-layers.svg" width="100%" alt="AgentProxy resilience — 3 independent self-healing layers, the right layer for the right failure. Layer 1 provider circuit breaker (whole provider): trips only on 408/5xx, thresholds OAuth 8× / API-key 12× / local 2×, resets 60s/30s/15s into a HALF-OPEN probe, lazy recovery; while OPEN the combo reroutes to the next provider. Layer 2 connection cooldown (one key/account): base 5s OAuth / 3s API-key, exponential ×2 backoff with anti-thundering-herd guard, 429 honors Retry-After, success clears all error state; one cooling key is skipped while sibling keys keep serving. Layer 3 model lockout (one model): per-model 429, local 404 or mode denials lock just that model — never the whole connection. Terminal states (banned, expired, credits exhausted) are for the operator, not cooldowns."/>
...
## 🏆 Mis teeb AgentProxy'i eriliseks

</div>

<img src="./docs/diagrams/comparison-table.svg" width="100%" alt="Mis teeb AgentProxy'i eriliseks — kuupäevastatud funktsioonide ülevaade vs 9router, OpenRouter, CLIProxyAPI ja LiteLLM 13 võimekuse lõikes. AgentProxy: 355 pakkujat, 150+ tasuta liiklust sisseehitatult, 19 ruutimisstrateegiat, 12-mootoriline tokenite kokkusurumine, sisseehitatud MCP-server 110 tööriistaga, A2A agendiprotokoll, püsimälu, kaitsepiirangud (guardrails), pilveagendid, TLS-jäljendi varjamine, Desktop/Termux/PWA ja 42 i18n kasutajaliidese keelt. AgentProxy on MIT-litsentsi all ja iseseisvalt majutatav. Konkurentide võimekused ja arvud võivad muutuda; vaata seotud metoodikat."/>

<sub>📊 Täielik metoodika ja funktsioonide detailne võrdlus vs 9router, OpenRouter, CLIProxyAPI ja LiteLLM → [`docs/comparison/AGENTPROXY_VS_ALTERNATIVES.md`](docs/comparison/AGENTPROXY_VS_ALTERNATIVES.md)</sub>

<br/>

## 💚 Toeta AgentProxy'i

AgentProxy on MIT-litsentsi all ja hooldatakse avatult. Kui see säästab teie aega või raha, siis siin on võimalused, kuidas hoida projekt iseseisvana — valige see, mis teile sobib. Sponsorlus ei mõjuta kunagi ruutimise prioriteeti; see ostab nähtavust, mitte paremusjärjestust.

<table>
  <tr><td nowrap>⭐ <b>Andke repole täht</b></td><td>Tasuta — aitab tegelikult nähtavust suurendada</td><td><a href="https://github.com/khanhkit/AgentProxy">Andke AgentProxy'ile täht</a></td></tr>
...
<img src="docs/assets/pix-qr.png" width="140" align="right" alt="AgentProxy PIX QR-kood"/>
...
🐛 Leidsid vea või on tagasisidet? Avage [arutelu (Discussion)](https://github.com/khanhkit/AgentProxy/discussions).
...
Peamine tasuta paketi pealkirjanumber on jätkuvalt **~1,51 miljardit tokenit kuus**, mis pärineb dokumenteeritud, poolide kaupa dubleerimisest puhastatud kataloogist ülal. Ajutised tootja registreerimiskrediidid võivad esimesel kuul seda eraldi tõsta kuni **~2,13 miljardini**. Radar on valikuline, allkirjastatud kataloogi ülekate neile, kes soovivad AgentProxy väljalaskete vahel värskemat tasuta mudelite kättesaadavust; kogukonna kataloog ja kõik olemasolevad tasuta funktsioonid jäävad tasuta.

Toetajad saavad ligipääsu reaalajas kataloogile ja täiendavatele tootjapõhistele võimalustele. Selle eraldi, muutuv ülempiir on **maksimaalselt umbes 3 miljardit tokenit kuus**, sõltuvalt tootjate saadavusest. See ülempiir ei ole garantii: tootjad võivad igal ajal muuta kvoote, õigustatust, mudeleid või regioone.

Radar on vabatahtlik ja kasutab ainult GET-päringuid. AgentProxy klient ei laadi üles päringuid, liiklust, tootja seadistust, kasutustelemeetriat ega kohalikku teavituste-suletud olekut. Loe õigustatuse ja praeguse kataloogi kohta lähemalt aadressil **[radar.agentproxy.online/planos](https://radar.agentproxy.example.com/planos)**.
...
- **🤖 Ühe käsuga CLI/agendi seadistus** — 13 registreeritud `setup-*` käsku; `agentproxy run` käivitab 7 CLI-d (Claude Code, Codex, Aider, Goose, OpenCode, Qwen Code, Gemini CLI); `agentproxy configure` toetab 10 sihtmärki interaktiivse tootja- ja mudelivalija ning kontekstipõhiste lemmikutega. → [CLI integratsioonid](docs/guides/CLI-INTEGRATIONS.md)
- **🛰️ Kaugrežiim** — juhi kaugjuhtimisega AgentProxy't piiratud õigustega tokenitega (`connect` / `contexts` / `tokens`) + `antigravity` OAuth abivahend VPS-i paigaldustele. → [Kaugrežiim](docs/guides/REMOTE-MODE.md)
...
- **💸 Kuludelemeetria kõikjal** — `X-AgentProxy-*` kulu/kasutuse päised igal lõpp-punktil, vahemälu-HIT-i säästupäis, võtmepõhised USD-kulude kvoodid. → [API viitedokumentatsioon](docs/reference/API_REFERENCE.md)
- **🧠 Sinu kontrolli all mälu** — vaikimisi väljas, valikuline int8 vektorkvantimine + tüübipõhine vähenemine, päringupõhine `x-agentproxy-no-memory`. → [Mälu](docs/frameworks/MEMORY.md)
...
## 🤖 Ühilduvad CLI-d ja koodiagendid

> Üks konfiguratsioon — `http://localhost:20128/v1` — ja **kõik** AI IDE-d või CLI-d töötavad tasuta ja odavate mudelitega.
...
<div align="center">
<b>＋ töötab ka koos</b> · Kiro · Command Code · Antigravity · Windsurf · AMP · <b>iga OpenAI-ühilduva tööriistaga</b>
</div>

<sub>📖 Iga tööriista jaoks eraldi seadistusjuhis kõigi 36 tööriista kohta (26 CLI koodiagenti + 10 CLI agenti) → [`docs/reference/CLI-TOOLS.md`](docs/reference/CLI-TOOLS.md) · 🧩 OpenCode plugin → [`@agentproxy/opencode-provider`](https://www.npmjs.com/package/@agentproxy/opencode-provider)</sub>

</div>

<br/>

**Käivita iga toetatud CLI AgentProxy kaudu ühe käsuga** — konfiguratsioonifaile ei kirjutata,
volitused süstitakse protsessi kaupa, Qwen/Gemini saavad ühekordse eraldatud kodukataloogi:
...
# Või vali provider+mudel interaktiivselt ja kirjuta tööriista oma konfiguratsioon:
agentproxy configure codex          # samuti: claude opencode qwen aider goose gemini cline continue kilo
```

Kõik käsud austavad aktiivset kaugkontekst (`agentproxy connect <host>`), `--dry-run`
näitab ette täpsed env/argumendid ilma käivitamata, ja `--api-key-env NAME` hoiab saladused
eemal sinu shelli ajaloost. → [CLI integratsioonid](docs/guides/CLI-INTEGRATIONS.md)
...
## 🖥️ Kus AgentProxy töötab — kõikjal
...
<table>
  ...
  <tr><td align="left" nowrap>📦 <b>npm (globaalne)</b></td><td align="left" nowrap><code>npm install -g agentproxy</code></td><td align="left">Üks käsklus, suvaline OS</td></tr>
  <tr><td align="left" nowrap>🐳 <b>Docker</b></td><td align="left" nowrap><code>docker run … khanhkit/agentproxy</code></td><td align="left">Multi-arhitektuurne <b>AMD64 + ARM64</b></td></tr>
  ...
  <tr><td align="left" nowrap>📱 <b>Android (Termux)</b></td><td align="left" nowrap><code>pkg install nodejs && npx -y agentproxy</code></td><td align="left">Töötab <b>sinu telefonis</b>, 24/7, ilma root-õigusteta</td></tr>
  ...
  <tr><td align="left" nowrap>🧩 <b>OpenCode plugin</b></td><td align="left" nowrap><code>@agentproxy/opencode-provider</code></td><td align="left">Native OpenCode integratsioon</td></tr>
  <tr><td align="left" nowrap>🤖 <b>VS Code Copilot Chat</b></td><td align="left" nowrap>paigalda <b>OmniCopilot</b> laiendus</td><td align="left">Iga AgentProxy'i mudel native Copilot Chati valikumenüüs — stabiilne &amp; Insiders</td></tr>
...
### 🧩 Uus: AgentProxy VS Code'i native Copilot Chati sees

</div>

> Ei ühtegi uut kõrvalpaneeli, ei ühtegi uut vestlusliidest — iga mudel, mida AgentProxy pakub,
...
oma AgentProxy serverile (vaikimisi `localhost:20128`), ning ava seejärel Copilot Chat → mudelivalija
...
Redaktori sees: ava vaade **Extensions**, otsi **"AgentProxy"**, klõpsa **Install**
...
<img src="./docs/diagrams/privacy-local.svg" width="100%" alt="Private and local-first — AgentProxy's gateway and control plane run on your machine. Prompts are sent to the upstream provider selected for each request; AgentProxy adds no hosted prompt-processing hop and telemetry is disabled by default. Credentials are encrypted at rest with AES-256-GCM; controls include API-key scoping, IP filtering, rate limits, prompt-injection guards, upstream-header scrubbing, opt-in PII redaction, sanitized errors and a local SQLite audit trail. AgentProxy is MIT-licensed and self-hostable."/>
...
> Lisaks serverile on AgentProxy **täielik käsurea juhtpult** koos **80+ käsuga**, ning avatud agendiprotokollid, mis võimaldavad AI-agendil seda **iseseisvalt** juhtida.

### ⌨️ Tõeline CLI (mitte ainult `start`)

```bash
agentproxy               # käivitab lüüsi + juhtpaneeli (port 20128)
agentproxy chat          # interaktiivne TUI vestlusklient (kaldkriips: /model /combo /skill /memory)
agentproxy setup         # juhendatud esmakäivituse viisard
agentproxy doctor        # diagnoosib teenusepakkujaid, porte, natiivseid sõltuvusi
```

### 🛰️ Kaugrežiim — käivita CLI siin, AgentProxy VPS-il

AgentProxy serveris? Juhi seda oma sülearvutist **samaga CLI-ga**. Logi sisse ühe korra
piiratud õigustega pöörduslubaga; iga järgnev käsk suunatakse siis kaugserverisse.

```bash
agentproxy connect 192.168.0.15            # parool → piiratud õigustega luba, salvestatakse kontekstina
agentproxy models list                     # ← töötab KAUGSERVERI vastu
agentproxy configure codex                 # ← valib kaugmudeli, kirjutab kohaliku Codexi profiili
agentproxy tokens create --name ci --scope read   # loob kitsamad load teistele masinatele
agentproxy contexts use default            # ← lülitub tagasi kohalikule serverile
```
...
<img src="./docs/diagrams/cli-terminal.svg" width="50%" alt="Animated terminal demoing the AgentProxy CLI — agentproxy providers list, agentproxy combo list and agentproxy health — cycling over the 86-command top-level surface: providers · oauth · keys · combo · nodes · models · cache · compression · cost · usage · quota · health · resilience · telemetry · logs · audit · mcp · a2a · cloud · memory · skills · eval · tunnel · backup · sync · webhooks · policy · pricing · translator · simulate …"/>

</div>

### 🤝 Ühenda agent — ja see juhib AgentProxy'i ennast

Ava AgentProxy üle **MCP**, **A2A**, **REST API**, **veebihaagiste (webhooks)** või **kaug-CLI** kaudu — iga võimekas agent (või oma kood) saab võtmed kogu lüüsi juurde: ruutimine, teenusepakkujad, kombinatsioonid, vahemälu, tihendus, mälu — kõik iseseisvalt. Allolevad HTTP lõpp-punktid on teenindatud aadressilt `http://localhost:20128`.

<table>
  <tr><th align="left">Liides</th><th align="left">Lõpp-punkt / käsk</th><th align="left">Kasutus</th></tr>
  <tr><td align="left" nowrap>🧰 <b>MCP (stdio)</b></td><td align="left" nowrap><code>agentproxy --mcp</code></td><td align="left">Ühenda Claude Desktopiga, Cursoriga, iga MCP kliendiga</td></tr>
  ...
  <tr><td align="left" nowrap>🛰️ <b>Kaug-CLI</b></td><td align="left" nowrap><code>agentproxy connect <host></code></td><td align="left">Juhi kaugeksemplari piiratud õigustega pöörduslubadega</td></tr>
</table>

```bash
# Anna Claude Code'ile täielik AgentProxy'i tööriistastik MCP kaudu:
...
<img src="./docs/diagrams/compression-pipeline.svg" width="100%" alt="AgentProxy'i tihendamise pipeline: illustratiivne 10 000-tokenine kliendipäring läbib 12 kombineeritavat mootorit — Session-Dedup, CCR, Lite, RTK, Responses Tool Output, Headroom, Relevance, Caveman, Aggressive, LLMLingua-2, Ultra ja OmniGlyph — ja jõuab pakkujani dokumenteeritud pinutatud näites umbes 1080 tokeniga. Struktureeritud sisu on kaitstud säilitusvalvurite ja iga etapi täpsusväravatega; selgesõnalised kahjustavad või eksperimentaalsed režiimid võivad sobivat sisu muundada."/>
...
> **Milleks kasutada palju tokeneid, kui vähestest piisab?** Iga päring läbib AgentProxy'i tihendamise pipeline'i **läbipaistvalt** — kliendipoolseid muudatusi ei vaja. See on nüüd **12 kombineeritava mootori pakett**, mis töötavad järjekorras ja segunevad vastavalt marsruutimiskombole — tuginedes ideedele projektidest [RTK](https://github.com/rtk-ai/rtk), [Caveman](https://github.com/JuliusBrussee/caveman) (⭐ 90K+), [LLMLingua-2](https://github.com/microsoft/LLMLingua) ja [Troglodita](https://github.com/leninejunior/troglodita) (PT-BR).
...
Peaksid näha saama oma ühendatud mudelite loetelu. 🎉 See on kõik — alusta kodeerimist, AgentProxy marsruutib ja teeb tagavaravariante sinu eest automaatselt.

Kui sinu klient ei saa saata kohandatud päiseid, pakub AgentProxy ka tokenistatud ühilduvusaliaseid:
...
> **Docker'i eelväljalaske kanal:** `khanhkit/agentproxy:next` ja
> `khanhkit/agentproxy:next-web` järgivad praegust vaikimisi `release/v*`
...
Standardne `bun install` ja globaalne paigaldus (`bun install -g agentproxy`) on toetatud Bun runtime'i tuvastamise abil:

- **Sisseehitatud `bun:sqlite`**: AgentProxy kasutab Buni sisseehitatud `bun:sqlite` draiverit, kui töötab Buni all, ning langeb tagasi `better-sqlite3` peale Node.js-il või `sql.js` peale.
- **Automaatne Webpack bundleri valik dev-režiimis**: Arendusrežiim (`bun run dev`) tuvastab automaatselt Buni ja lülitab Turbopacki välja, kasutades selle asemel Webpacki, et vältida natiivsete V8 seoste ühilduvusprobleeme. Tootmisbuildid (`bun run build`) järgivad `AGENTPROXY_USE_TURBOPACK` täpselt nagu Node'iga: vaikimisi Turbopack, `AGENTPROXY_USE_TURBOPACK=0` build'imiseks Webpackiga (`Dockerfile.bun` teeb selle kättesaadavaks `--build-arg`-na).
- **Eraldi Bun Dockerfile**: Mitmeetapiline `Dockerfile.bun` natiivsete Buni tootmiskeskkonna juurutuste jaoks (`docker build -f Dockerfile.bun -t agentproxy:bun .`).
...
```bash
AGENTPROXY_SKIP_POSTINSTALL=1 npm install -g agentproxy   # CI=1 jätab selle samuti vahele
```
...
> 🎬 **Tegid AgentProxy'ist video?** Ava [issue](https://github.com/khanhkit/AgentProxy/issues/new) või [arutelu](https://github.com/khanhkit/AgentProxy/discussions), lisades lingi — toome selle siin esile.
...
| 🌍 **Veebisait**                                | [agentproxy.online](https://agentproxy.example.com)                                                                                |
| 🌍 **🌍StHub AgentProxy kogukond (tasuta)**      | [portal sthub](https://portal.sthub.com.br/communities/groups/st-hub/channels/AgentProxy-World-8kRjmK)                       |
| 📦 **Lähtekood**                                | [github.com/khanhkit/AgentProxy](https://github.com/khanhkit/AgentProxy)                                              |
| 🐛 **Teata veast**                              | [ava issue](https://github.com/khanhkit/AgentProxy/issues) — lisa `npm run system-info` väljund                          |
...
| 💚 **Toeta projekti**                           | [Toetamise võimalused ↑](#-support-agentproxy) · [GitHub Sponsors](https://github.com/sponsors/diegosouzapw)                 |
...
<table>
  ...
  <tr><td nowrap><b>Lingid</b></td><td><a href="https://agentproxy.example.com">Veebisait</a> · <a href="https://www.npmjs.com/package/agentproxy">npm</a> · <a href="https://github.com/khanhkit/AgentProxy/pkgs/container/agentproxy">Docker Hub</a></td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/REMOTE-MODE.md">Kaugrežiim</a></b></td><td>Halda kaugsuse AgentProxy't (VPS) sülearvuti käsurealt piiratud pöörduslubadega</td></tr>
  <tr><td nowrap><b><a href="docs/guides/CLAUDE-CODE-CONFIGURATION.md">Claude Code seadistus</a></b></td><td>Suuna Claude Code AgentProxy'ile (kohalik/kauge) kasutades <code>launch</code> käsku ja mudelipõhiseid profiile</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/TERMUX_GUIDE.md">Termux juhend</a></b></td><td>Käivita AgentProxy Androidil Termuxi kaudu</td></tr>
...
> AgentProxy'i kujundab kirglik avatud lähtekoodi kogukond. Need inimesed on andnud erakordse panuse, mis mõjutab otseselt projekti kvaliteeti, stabiilsust ja haardeulatust. **Suur tänu.**
...
> 🙏 Nende panustajate funktsioonid, veaparandused ja infrastruktuuri täiendused on **oluline osa** sellest, mis teeb AgentProxy'i usaldusväärseks ja funktsioonirikkaks. Iga pull request, iga testjuhtum ja iga i18n tõlkefail on tähtis. Avatud lähtekood on ehitatud selliste inimeste poolt.
...
Südamlik tänu inimestele, kes rahastavad AgentProxy't oma taskust — igaüks nendest panustustest hoiab projekti tasuta, sõltumatuna ja liikumas.
...
<b><a href="https://github.com/sponsors/diegosouzapw">💖 Hakka sponsoriks →</a></b> — igaüks dollarist hoiab AgentProxy'i tasuta ja sõltumatuna.
...
<table>
  <tr><th align="left">Projekt</th><th align="center">⭐</th><th align="left">Kuidas see AgentProxy'i inspireeris</th></tr>
  ...
  <tr><td nowrap><b><a href="https://github.com/ex-machina-co/opencode-anthropic-auth">opencode-anthropic-auth</a></b></td><td align="center">510</td><td>Claude Code-ga ühilduvad teisendusvaikeväärtused ja arveldus-päise käitumine, üldistatud AgentProxy'i konfiguratsioonipõhisesse sillasse.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/520mmxx/grok2api-merged">grok2api-merged</a></b></td><td align="center">2</td><td>Selle Grok mudeli kaardistused, võlts-TypeError Statsig generaator, päringu- ja seadme vaikeväärtused ning NDJSON vastuse töötleja on sisuliselt kohandatud AgentProxy'i Grok Web täitja jaoks.</td></tr>
  ...
  <tr><td nowrap><b><a href="https://github.com/miuzhaii/grok2api-pro">grok2api-pro</a></b></td><td align="center">27</td><td>Transitiivne allikas, mille grok2api-merged tunnustab proksi-puuli kihi eest; AgentProxy säilitab selle pärandimärke, kuid ei väida oma piiratud Grok Web täitjas proksi-puuli porti.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/CNFlyCat/GrokProxy">GrokProxy</a></b></td><td align="center">50</td><td>Selle küpsise-autentimisega Grok proksi ja <code>result.response.token</code> voogesitusmuster mõjutasid AgentProxy'i Grok Web transporti.</td></tr>
  ...
  <tr><td nowrap><b><a href="https://github.com/imjustprism/grok-web-api">grok-web-api</a></b></td><td align="center">14</td><td>Selle Rust <code>ChatOptions</code> ja vastuse-ümbriku skeemid mõjutasid AgentProxy'i TypeScript Grok päringu- ja voogesitus-vastuse tüüpe.</td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="https://github.com/ayghri/i-have-adhd">i-have-adhd</a></b></td><td align="center">23 526</td><td>Selle tegevuseelistav, ADHD-sõbralik vastusestiil on kohandatud AgentProxy'i kompaktseks väljundistiiliks viies keeles.</td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="https://github.com/blackwell-systems/gcf">GCF – Graph Compact Format</a></b></td><td align="center">41</td><td>Selle kompaktne graafivorming ja generic-profiili disain mõjutasid AgentProxy'i tabelikuju tihendust ja Headroom koodeki vormingut.</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="https://github.com/lbjlaq/Antigravity-Manager">Antigravity-Manager</a></b></td><td align="center">30 652</td><td>Selle konto-teadlik mudeli ümberkaardistamine, käivitatava faili tee valideerimine ja plaanimärgise käitumine mõjutasid AgentProxy'i Antigravity käitusaega.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/jlcodes99/vscode-antigravity-cockpit">vscode-antigravity-cockpit</a></b></td><td align="center">4 817</td><td>Selle kompaktne kvoodi-taastamise loenduri vorming inspireeris AgentProxy'i vastavat teenusepakkuja-piirangu kuvamist.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/iOfficeAI/AionUi">AionUi</a></b></td><td align="center">32 230</td><td>Selle ACP integratsioonid inspireerisid AgentProxy'i installitud CLI-agentide automaatset tuvastamist.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/steipete/CodexBar">CodexBar</a></b></td><td align="center">20 507</td><td>Tuvastas Grok Build kvoodipinna; AgentProxy kontrollis ja korrigeeris seejärel elava juhtmevormingu iseseisvalt.</td></tr>
</table>
...
**[⬆ Tagasi üles](#-agentproxy)** · Loodud ❤️-ga avatud lähtekoodiga AI kogukonna jaoks.
