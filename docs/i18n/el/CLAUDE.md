...
προσωρινά/εργασιακά αρχεία — εξαγωγές, παραγόμενα zip, εφάπαξ ενδιάμεσες εξόδους, οτιδήποτε θα βάζατε αλλιώς στο `/tmp` — στο `/home/diegosouzapw/dev/proxys/AgentProxy/_artifacts/` αντ' αυτού.
