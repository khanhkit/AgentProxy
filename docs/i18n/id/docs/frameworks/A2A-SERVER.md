# Dokumentasi Server A2A AgentProxy (Bahasa Indonesia)
...
> Protokol Agent-to-Agent v0.3 — AgentProxy sebagai agen routing cerdas
...
Mengembalikan Kartu Agen yang mendeskripsikan kemampuan, keterampilan, dan persyaratan autentikasi AgentProxy.
...
| :----------------- | :-------------------------------------------------------------------------------------------------------------------------------- |
| `smart-routing`    | Merutekan prompt melalui pipeline cerdas AgentProxy. Mengembalikan respons beserta penjelasan routing, biaya, dan jejak ketahanan. |
