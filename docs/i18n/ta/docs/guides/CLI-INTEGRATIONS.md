...
AgentProxy ஒரு குறியீட்டு CLI (Codex, Claude Code, OpenCode, Cline, …) ஐ AgentProxy ஐ அதன் பின்னணி ஆக பயன்படுத்த அமைக்க `setup-*` கட்டளைகளின் குடும்பத்தை வழங்குகிறது — எனவே, இந்த கருவி **ஒரு** முடிவுறையைப் பேசுகிறது மற்றும் AgentProxy சரியான வழங்குநருக்கு வழி வகுக்கிறது மற்றும் தானாகவே மீள்கிறது. ஒவ்வொரு கட்டளையும் ஓர் இயங்கும் AgentProxy (உள்ளூர் அல்லது தொலைதூரம்) இல் இருந்து **உயிர்** மாதிரி பட்டியலைப் படிக்கிறது மற்றும் **உங்கள்** கணினியில் கருவியின் சொந்த கட்டமைப்பு கோப்பை எழுதுகிறது. API விசை கருவி அதை ஆதரிக்கும் இடங்களில் ஒரு சுற்றுப்புற மாறியில் குறிப்பிடப்படுகிறது. கருவி-உள்ளூர் சுற்றுப்புற கோப்பை நிலைநாட்டும் கட்டளைகள் கீழே குறிப்பிடப்பட்டுள்ளன.

ஒரு பொதுவான தொடக்கமும் உள்ளது — `agentproxy run <target>` — இது `claude`, `codex`, `aider`, `goose`, `opencode`, `qwen` அல்லது `gemini` ஐ சரியான சுற்றுப்புறம் ஊட்டியுடன் உருவாக்குகிறது, எந்த கட்டமைப்பையும் எழுதாமல். இலக்குகள் மற்றும் அவற்றின் பெயர்கள் `bin/cli/cli-manifest.mjs` என்ற மானிபெஸ்டில் இருந்து வருகின்றன (`claude-code|cc|anthropic`, `codex-cli|openai-codex|openai`, `goose-cli`, `open-code`, `qwen-code`, `gemini-cli`), மற்றும் `agentproxy completion` ஒரே மானிபெஸ்டில் இருந்து பெறப்பட்ட இலக்க வார்த்தைகளை வழங்குகிறது. பழமையான கருவி தொடக்கங்கள் — `agentproxy launch` (Claude Code) மற்றும் `agentproxy launch-codex` (Codex) — கிடைக்கின்றன.
...
- [தொலைதூர முறை](./REMOTE-MODE.md) — உங்கள் லேப்டாப்பிலிருந்து தொலைதூர AgentProxy (VPS / Tailnet) ஐ இயக்குங்கள்
...
ஒவ்வொரு கட்டளையும் **செயல்பாட்டில் உள்ள சூழ்நிலை** ( `agentproxy connect` மூலம் அமைக்கப்பட்டது, [தொலைதூர முறை](./REMOTE-MODE.md) ஐப் பார்க்கவும்) அல்லது தெளிவான `--remote <url> --api-key <key>` கொடுக்கப்பட்ட விருப்பங்களை மதிக்கிறது. "உள்ளூர் மற்றும் தொலைதூரம்" கீழே உள்ளதாவது: எந்த விருப்பங்களும் இல்லாமல் இது `http://localhost:20128` ஐ நோக்குகிறது; `--remote` (அல்லது செயல்பாட்டில் உள்ள தொலைதூர சூழ்நிலை) உடன், அந்த சேவையகத்திலிருந்து பட்டியலைப் பெறுகிறது மற்றும் உள்ளூர் கட்டமைப்பை எழுதுகிறது.

| கட்டளை                     | கருவி                        | இது என்ன எழுதுகிறது                                                                                                                                                                                                          | முக்கிய விருப்பங்கள்                                                                                                                       | உள்ளூர் மற்றும் தொலைதூரம் |
| -------------------------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------- |
| `agentproxy setup-codex`    | OpenAI Codex CLI             | `~/.codex/<name>.config.toml` — ஒவ்வொரு பொருத்தமான உரை மாதிரிக்கு ஒரு சுயவிவரம் (`codex --profile <name>`)                                                                                                                   | `--remote` `--api-key` `--only` `--dry-run` `--port` `--codex-home`                                                                        | இரண்டும்                  |
| `agentproxy setup-claude`   | Claude Code                  | `~/.claude/profiles/<name>/settings.json` — ஒவ்வொரு பொருத்தமான மாதிரிக்கு ஒரு சுயவிவரம் (`CLAUDE_CONFIG_DIR`)                                                                                                                | `--remote` `--api-key` `--only` `--dry-run` `--port` `--claude-home`                                                                       | இரண்டும்                  |
| `agentproxy setup-opencode` | OpenCode (openai-compatible) | `~/.config/opencode/opencode.json` — ஒவ்வொரு பட்டியலின் மாதிரியுடன் `agentproxy` வழங்குநர் (`opencode -m agentproxy/<model>`)                                                                                                  | `--remote` `--api-key` `--only` `--model` `--dry-run` `--port`                                                                             | இரண்டும்                  |
| `agentproxy setup-cline`    | Cline                        | `~/.cline/data/{globalState,secrets}.json` (CLI முறை) + VS Code நீட்சியின் அமைப்புகளை அச்சிடுகிறது                                                                                                                           | `--remote` `--api-key` `--model` `--yes` `--dry-run` `--port` `--cline-dir`                                                                | இரண்டும்                  |
| `agentproxy setup-kilo`     | Kilo Code                    | `~/.local/share/kilo/auth.json` (CLI) + இருந்தால் VS Code `settings.json` இல் `kilocode.*` ஐ இணைக்கிறது                                                                                                                      | `--remote` `--api-key` `--model` `--yes` `--dry-run` `--port` `--auth-path` `--vscode-settings`                                            | இரண்டும்                  |
| `agentproxy setup-continue` | Continue / `cn` CLI          | `~/.continue/config.yaml` — `provider: openai` மாதிரிகள், விசை `${{ secrets.AGENTPROXY_API_KEY }}` மூலம்                                                                                                                      | `--remote` `--api-key` `--only` `--dry-run` `--port` `--config-path`                                                                       | இரண்டும்                  |
| `agentproxy setup-cursor`   | Cursor                       | எதுவும் இல்லை — செயலியில் உள்ள படிகளை அச்சிடுகிறது (Cursor கட்டமைப்பு மறைமுக SQLite)                                                                                                                                         | `--remote` `--api-key` `--only` `--port`                                                                                                   | இரண்டும்                  |
| `agentproxy setup-roo`      | Roo Code                     | `~/.agentproxy/roo-settings.json` (இறக்குமதி ஆவணம்) + ஒரு VS Code `settings.json` இருந்தால் `roo-cline.autoImportSettingsPath` ஐ அமைக்கிறது                                                                                   | `--remote` `--api-key` `--model` `--yes` `--dry-run` `--port` `--import-path` `--vscode-settings`                                          | இரண்டும்                  |
| `agentproxy setup-crush`    | Crush                        | `~/.config/crush/crush.json` — `openai-compat` வழங்குநர், விசை `$AGENTPROXY_API_KEY` மூலம்                                                                                                                                    | `--remote` `--api-key` `--only` `--dry-run` `--port` `--config-path`                                                                       | இரண்டும்                  |
| `agentproxy setup-goose`    | Goose                        | `~/.config/goose/config.yaml` (`GOOSE_PROVIDER`/`OPENAI_HOST`/`GOOSE_MODEL`) + சுற்றுப்புற செய்முறை                                                                                                                          | `--remote` `--api-key` `--model` `--yes` `--dry-run` `--port` `--config-path`                                                              | இரண்டும்                  |
| `agentproxy setup-aider`    | Aider                        | `~/.aider.conf.yml` (`openai-api-base` + `model: openai/<id>`) + சுற்றுப்புற செய்முறை                                                                                                                                        | `--remote` `--api-key` `--model` `--yes` `--dry-run` `--port` `--config-path`                                                              | இரண்டும்                  |
| `agentproxy setup-qwen`     | Qwen Code                    | `~/.qwen/settings.json` — V4 `modelProviders.openai` வரிசை + `AGENTPROXY_API_KEY` `~/.qwen/.env` இல்                                                                                                                          | `--remote` `--api-key` `--model` `--yes` `--dry-run` `--port` `--config-path` `--env-path`                                                 | இரண்டும்                  |
| `agentproxy run <target>`   | Runtime launch (generic)     | எதுவும் இல்லை — சரியான சுற்றுப்புறம் மற்றும் аргументы உடன் `claude`/`codex`/`aider`/`goose`/`opencode`/`qwen`/`gemini` ஐ உருவாக்குகிறது; Qwen மற்றும் Gemini ஒரு தற்காலிகமாக தனிமைப்படுத்தப்பட்ட வீட்டைப் பயன்படுத்துகின்றன | `--remote` `--base-url` `--context` `--provider` `--model` `--api-key` `--api-key-env` `--dry-run` `--json` `--port` `--profile` `--token` | இரண்டும்                  |
| `agentproxy launch`         | Claude Code                  | எதுவும் இல்லை — `ANTHROPIC_BASE_URL`/`ANTHROPIC_AUTH_TOKEN` ஊட்டியுடன் `claude` ஐ உருவாக்குகிறது                                                                                                                             | `--remote` `--api-key` `--token` `--profile` `--port`                                                                                      | இரண்டும்                  |
| `agentproxy launch-codex`   | OpenAI Codex CLI             | எதுவும் இல்லை — `-c` விருப்பங்கள் மூலம் `agentproxy` வழங்குநரை ஊட்டியுடன் `codex` ஐ உருவாக்குகிறது                                                                                                                            | `--remote` `--api-key` `--profile` (`-p`) `--port`                                                                                         | இரண்டும்                  |

விருப்பங்கள் பற்றிய குறிப்புகள் (கட்டளை மூலத்தில் சரிபார்க்கப்பட்டது):

- `--remote <url>` — தொலைதூர AgentProxy இல் இருந்து பட்டியலைப் பெறுகிறது ( `--port` மற்றும் செயல்பாட்டில் உள்ள சூழ்நிலையை மீறுகிறது). `--api-key <key>` அந்த சேவையகத்திற்கான சான்றிதழை வழங்குகிறது (இது `AGENTPROXY_API_KEY` சுற்றுப்புற மாறி அல்லது செயல்பாட்டில் உள்ள சூழ்நிலையின் டோக்கனை அடிப்படையாகக் கொண்டது).
...
- `--model <id>` `agentproxy run` இல் மானிபெஸ்டின் இலக்கத்திற்கு ஏற்ப wiring ஐ பின்பற்றுகிறது (`bin/cli/cli-manifest.mjs`): **aider** `--model openai/<id>` ஐப் பெறுகிறது மற்றும் **opencode** `--model agentproxy/<id>` ஐப் பெறுகிறது (அந்த அடையாளம் ஏற்கனவே அதை கொண்டிருந்தால் முன்னணி சேர்க்கப்படாது); **qwen** மற்றும் **gemini** அடையாளத்தை நேரடியாகப் பெறுகின்றன; **claude** அதை `ANTHROPIC_MODEL` மூலம் பெறுகிறது, **goose** `GOOSE_MODEL` மூலம், மற்றும் **codex** `-c model_providers.agentproxy.*` аргументы மூலம் பெறுகிறது. **Qwen என்பது `--model` ஐ கடுமையாக தேவைப்படும் ஒரே இயக்க இலக்கு** — `agentproxy run qwen` இல் இல்லாமல் அது `2` என்ற வெளிப்படையான பிழையுடன் வெளியேறும்.
- `--port <port>` — உள்ளூர் AgentProxy போர்ட் (இயல்பாக `20128`, `--remote` அமைக்கப்பட்டால் புறக்கணிக்கப்படுகிறது). அனைத்து `setup-*` மற்றும் இரண்டு தொடக்கங்களில் உள்ளன.
- `agentproxy run` வெளியேற்றக் குறியீடுகள்: குழந்தை CLI இன் சொந்த வெளியேற்றக் குறியீடு நேரடியாக பரவுகிறது; `2` = தவறான аргументы (ஆதரிக்கப்படாத இலக்கு, தேவைப்படும் `--model` இல் குறைவாக, கொண்டெய்னர் காப்பகம்); `127` = இலக்கு பைனரி `PATH` இல் இல்லை; `130`/`143`/`129` `SIGINT`/`SIGTERM`/`SIGHUP` மூலம் தொடக்கம் முடிவுக்கு வந்தால்; `1` = பிற இயக்க தொடக்க தோல்வி.
...
> மேலும் ஒரு செழுமையான பிளக்கின் ஒருங்கிணைப்பு உள்ளது — `agentproxy setup opencode` — இது `@agentproxy/opencode-plugin` ஐ நிறுவுகிறது. அவை வெவ்வேறு கட்டளைகள்; மேலே உள்ள அட்டவணை `setup-opencode` ஐ ஆவணமாக்குகிறது.

---

## உள்ளூர் பயன்பாடு

`localhost:20128` இல் AgentProxy இயங்கும் போது, உங்கள் கருவிக்கான அமைப்பு கட்டளையை இயக்கவும். பட்டியல் உள்ளூர் சேவையிலிருந்து பெறப்படுகிறது.
...
export AGENTPROXY_API_KEY=sk-...  # {env:AGENTPROXY_API_KEY} மூலம் குறிப்பிடப்பட்டுள்ளது, எப்போதும் டிஸ்கில் இல்லை
...
```bash
agentproxy launch                 # Claude Code → உள்ளூர் AgentProxy
agentproxy launch-codex           # Codex CLI → உள்ளூர் AgentProxy
...
எந்த அமைப்பு கட்டளையையும் `--remote` + `--api-key` உடன் தொலைபேசி AgentProxy க்கு குறிக்கவும். பட்டியல் தொலைபேசியில் பெறப்படுகிறது; கட்டமைப்பு உங்கள் உள்ளூர் இயந்திரத்தில் எழுதப்படுகிறது.
...
agentproxy setup-opencode --remote http://192.168.0.15:20128 --api-key oma_live_xxx \
  --only glm,kimi
opencode -m agentproxy/glm/glm-5.2 "..."   # முதலில் AGENTPROXY_API_KEY ஐ ஏற்றுமதி செய்யவும்
...
```bash
agentproxy connect 192.168.0.15        # ஒரு scoped token ஐ உருவாக்குகிறது, சூழலை சேமிக்கிறது
agentproxy setup-codex                 # ← இப்போது தொலைபேசி பட்டியலைப் பயன்படுத்துகிறது
agentproxy setup-opencode              # ← அதே
agentproxy launch                      # ← Claude Code தொலைபேசிக்கு
```
...
AgentProxy OpenAI மேற்பரப்பை `/v1` இல், Anthropic மேற்பரப்பை அடிப்படையில், மற்றும் ஒரு உள்ளூர் Gemini மேற்பரப்பை `/v1beta` இல் வெளிப்படுத்துகிறது. ஒவ்வொரு ஒருங்கிணைப்பும் அதன் கருவி எதிர்பார்க்கும் வடிவத்திற்கு இணைக்கப்பட்டுள்ளது (கட்டளை மூலத்தில் சரிபார்க்கப்பட்டது):
...
| `setup-codex`, `launch-codex` (`model_providers.agentproxy.base_url`)       | `/v1` உடன்              | ஆம்                                                    |
...
நீங்கள் `agentproxy update` மூலம் புதுப்பிக்கும்போது (உறுதிப்படுத்திய பிறகு, அல்லது `--apply` உடன்),
AgentProxy `--include=optional` உடன் நிறுவலை இயக்குகிறது:

```bash
npm install -g agentproxy@latest --include=optional
```

இது `agentproxy update` க்கு நீங்கள் வழங்கும் ஒரு கொடி **இல்லை** — இது எப்போதும்
...
மற்ற `agentproxy update` கொடிகள் (மூலத்தில் சரிபார்க்கப்பட்டது): `--check` (பழையதாக இருந்தால் 1 ஐ வெளியேற்றவும்), `--apply` (கேள்வி இல்லாமல் நிறுவவும்), `--changelog`, `--no-backup`,
`--yes`.

---

## Google Gemini CLI மூலம் `agentproxy run gemini`
...
(மற்றும் `:streamGenerateContent?alt=sse`) அதற்கு எதிராக வெளியிடுகிறது — இது AgentProxy இன் உள்ளூர்
Gemini மேற்பரப்பின் ( `/v1beta`). `agentproxy run gemini` அதை தானாகவே இணைக்கிறது:

- `GOOGLE_GEMINI_BASE_URL` → செயல்பாட்டில் உள்ள AgentProxy அடிப்படை URL (மூல, `/v1` இல்லை);
- `GEMINI_API_KEY` → தீர்க்கப்பட்ட AgentProxy அங்கீகாரம் (விருப்பம்/சூழல்/சூழல்);
- ஒரு **தற்காலிக தனிமைப்படுத்தப்பட்ட `GEMINI_CLI_HOME`** இதன் `.gemini/settings.json`
  ...
  AgentProxy-க்கு வழிநடத்தும் தொடக்கத்தை மீறாது — வெளியேறிய பிறகு நீக்கப்படுகிறது;
...
`tests/unit/cli/run-execution.test.ts`). உண்மையான AgentProxy சேவையகத்திற்கான உண்மையான
...
தேர்வாக: `AGENTPROXY_SMOKE_TARGETS="codex,opencode,qwen"` சுத்தத்தை கட்டுப்படுத்துகிறது;
`AGENTPROXY_SMOKE_TIMEOUT_MS` 120s ஒவ்வொரு இலக்கத்திற்கான நேரத்தை மீறுகிறது.
...
- [Codex CLI கட்டமைப்பு](./CODEX-CLI-CONFIGURATION.md) — ஒரே முறை `[model_providers.agentproxy]` அடிப்படை அமைப்பு
