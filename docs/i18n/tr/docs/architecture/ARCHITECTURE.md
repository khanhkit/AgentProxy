...
AgentProxy, Next.js üzerine inşa edilmiş yerel bir yapay zeka yönlendirme ağ geçidi (AI routing gateway) ve yönetim panosudur.
...
flowchart LR
    ...
    subgraph Router[AgentProxy Yerel Süreci]
...
AgentProxy, **SQLite** (better-sqlite3) ve **WAL (Write-Ahead Logging)** günlük kaydı kullanır:
