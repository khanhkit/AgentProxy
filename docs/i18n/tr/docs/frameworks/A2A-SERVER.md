---
title: "AgentProxy A2A Sunucu Dokümantasyonu"
version: 3.8.50
lastUpdated: 2026-08-23
---

# AgentProxy A2A Sunucu Dokümantasyonu (Türkçe)
...
> Agent-to-Agent Protokolü v0.3 — Akıllı bir yönlendirme ajanı olarak AgentProxy
...
AgentProxy'un yeteneklerini, becerilerini ve kimlik doğrulama gereksinimlerini açıklayan Ajan Kartını (Agent Card) döndürür.
...
```
Authorization: Bearer SIZIN_AGENTPROXY_API_ANAHTARINIZ
```
