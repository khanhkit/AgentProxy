...
**AgentProxy** — unified AI proxy/router. One endpoint, 329 provider catalog entries, auto-fallback when an upstream route is available.
...
AgentProxy has **~48 quality-gate scripts** (`scripts/check/` + `scripts/quality/`) wired
