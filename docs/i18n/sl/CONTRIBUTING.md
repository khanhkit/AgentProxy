# Contributing to AgentProxy (Slovenščina)
...
> **Opomba za uvedbo na VPS:** oddaljeni imenik slike `/usr/lib/node_modules/agentproxy/app/`
...
open-sse/                   # Delovni prostor @agentproxy/open-sse
...
├── comparison/              # AgentProxy v primerjavi z alternativami
...
- **Težave**: [github.com/khanhkit/AgentProxy/issues](https://github.com/khanhkit/AgentProxy/issues)
