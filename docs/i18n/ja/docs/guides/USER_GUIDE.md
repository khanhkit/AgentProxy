...
| `CLOUD_URL`                             | `https://agentproxy.example.com`              | Cloud sync endpoint base URL                                                                              |
