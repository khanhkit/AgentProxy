...
**AgentProxy** — ఏకీకృత AI ప్రాక్సీ/రౌటర్. ఒక ఎండ్‌పాయింట్, 329 LLM ప్రొవైడర్లు, ఆటో-ఫాల్బ్యాక్.
...
- **ఇంపోర్ట్స్**: బాహ్య → అంతర్గత (`@/`, `@agentproxy/open-sse`) → సంబంధిత
...
- **పాత్ అలియాసులు**: `@/*` → `src/`, `@agentproxy/open-sse` → `open-sse/`, `@agentproxy/open-sse/*` → `open-sse/*`
- **డిఫాల్ట్ పోర్ట్**: 20128 (API + డాష్‌బోర్డ్ ఒకే పోర్ట్‌లో)
- **డేటా డైరెక్టరీ**: `DATA_DIR` env var, డిఫాల్ట్ గా `~/.agentproxy/`
