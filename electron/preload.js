/**
 * AgentProxy Electron Desktop App - Preload Script
 *
...
const MAC_DRAG_STYLE_ID = "agentproxy-electron-drag-region-style";
const MAC_DRAG_FALLBACK_ID = "agentproxy-electron-drag-region";
const MAC_DRAG_OBSERVER_KEY = "__agentproxyMacDragRegionObserver";
...
function installMacDragRegion() {
  ...
  const attach = () => {
    ...
    style.textContent = `
      header,
      .agentproxy-electron-drag-region {
        app-region: drag;
    ...
    dragRegion.className = "agentproxy-electron-drag-region";
