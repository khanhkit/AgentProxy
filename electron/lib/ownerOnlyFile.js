...
function applyOwnerOnlyPermissionsSync(filePath, runtime = {}) {
...
function repairOwnerOnlyFileSync(filePath, runtime = {}) {
  const platform = runtime.platform ?? process.platform;
  assertSafeParentDirectory(filePath, platform);
  applyOwnerOnlyPermissionsSync(filePath, runtime);
}

function writeOwnerOnlyFileSync(filePath, data, options = {}) {
