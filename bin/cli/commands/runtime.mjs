...
/**
 * Shared repair action used by both `agentproxy runtime repair` and the
 * top-level `agentproxy repair` alias. Reinstalls better-sqlite3 into the
...
export function registerRuntime(program) {
  ...
  // Top-level discoverability alias: `agentproxy repair` invokes the SAME action
  // as `agentproxy runtime repair` (no duplicated logic). Surfaced in the
