...
/**
 * AgentProxy — Stage 7 build-time optional-pack staging (issue #10321).
 *
 ...
 *     `AGENTPROXY_OPTIONAL_PACK_TAR=0`) for the desktop release workflow to
...
export async function stageOptionalPacks({
  stagingRoot,
  packsOutDir,
  emitTarballs = process.env.AGENTPROXY_OPTIONAL_PACK_TAR !== "0",
  log = () => {},
}) {
  const packsOut = [];
  const indexPacks = [];
