...
/**
 * Writes BUILD_AGENTPROXY_BASE_PATH into the standalone bundle so container start
 * can compare the baked Next.js basePath against AGENTPROXY_BASE_PATH.
 */
...
function writeSentinel(targetDir) {
  ...
  const sentinel = path.join(targetDir, "BUILD_AGENTPROXY_BASE_PATH");
