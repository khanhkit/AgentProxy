...
/**
 * write-build-sha.mjs — HEAD sentinel guard for AgentProxy release builds.
 *
 * Writes AGENTPROXY_BUILD_SHA (or git rev-parse --short HEAD) into:
 *   - dist/BUILD_SHA
...
function resolveBuildSha() {
  if (process.env.AGENTPROXY_BUILD_SHA) {
    return process.env.AGENTPROXY_BUILD_SHA.trim();
  }
  try {
