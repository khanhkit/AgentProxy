...
const baseUrl = (process.env.AGENTPROXY_BASE_URL || "http://127.0.0.1:20128").replace(/\/$/, "");
...
console.log("AgentProxy Verification");
...
try {
  ...
  const status = await get("/api/agentproxy/status");
