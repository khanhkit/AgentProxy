...
const MESSAGE_OVERRIDES = {
  es: {
    ...
    "auth.stopServer": "Detén el servidor AgentProxy",
  ...
  ja: {
    ...
    "auth.stopServer": "AgentProxy サーバーを停止",
...
const README_NAV_OVERRIDES = {
  "README.ja.md":
    "[🌐 ウェブサイト](https://agentproxy.example.com) • [🚀 クイックスタート](#-クイックスタート) • [💡 主な機能](#-主な機能) • [📖 ドキュメント](#-ドキュメント) • [💰 料金](#-価格の概要) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)",
  "README.ar.md":
    "[🌐 الموقع](https://agentproxy.example.com) • [🚀 البداية السريعة](#-بداية-سريعة) • [💡 الميزات](#-الميزات-الرئيسية) • [📖 التوثيق](#-التوثيق) • [💰 الأسعار](#-لمحة-سريعة-عن-الأسعار) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)",
};
...
function removeEnglishPortugueseAnchorLine(content) {
  ...
  const filtered = lines.filter(
    (line) =>
      !line.includes(
        "**[English](#-agentproxy--the-free-ai-gateway)** | **[Português (BR)](#-agentproxy--gateway-de-ia-gratuito)**"
      )
  );
