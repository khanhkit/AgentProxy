...
export const APIKEY_PROVIDERS_GATEWAYS = {
  ...
  // AgentProxy's oneminai executor translates both directions.
  oneminai: {
    id: "oneminai",
    serviceKinds: ["llm"],
    alias: "1min",
    ...
    apiHint:
      "1min.ai uses a proprietary chat API (single prompt string + SSE) instead of OpenAI chat/completions. AgentProxy flattens OpenAI messages into a labeled prompt and translates the SSE stream.",
  ...
  "g4f-groq": {
    ...
    notice: {
      text: "Remote third-party gateway: prompts and request metadata leave AgentProxy and are handled by g4f.space. Its Terms and Privacy links were unavailable when last verified on 2026-08-27.",
  ...
  zenmux: {
    ...
    apiHint:
      "ZenMux exposes an OpenAI-compatible chat completions endpoint at /api/v1/chat/completions, plus Anthropic Messages (/api/anthropic/v1/messages) and Google Gemini (/api/vertex-ai) protocol surfaces. AgentProxy uses the OpenAI protocol.",
  },
  openadapter: {
    id: "openadapter",
    serviceKinds: ["llm"],
    ...
    apiHint:
      "OpenAdapter exposes an OpenAI-compatible chat completions endpoint at https://api.openadapter.in/v1/chat/completions, aggregating 70+ open-source models (DeepSeek, Qwen, Kimi, MiniMax, GLM, Llama, Mistral, …). AgentProxy uses the OpenAI protocol.",
  },
  dit: {
    id: "dit",
    serviceKinds: ["llm"],
    ...
    apiHint:
      "dit.ai (Distributed Intelligence Trade) is an OpenAI-compatible router/gateway with dynamic per-request pricing, exposing /v1/chat/completions at https://api.dit.ai/v1. AgentProxy uses the OpenAI protocol; spend/savings analytics live in the dit.ai dashboard.",
  },
  tokenrouter: {
    id: "tokenrouter",
    serviceKinds: ["llm"],
    ...
    apiHint:
      "TokenRouter exposes an OpenAI-compatible chat completions endpoint at https://api.tokenrouter.com/v1/chat/completions, plus a working /v1/models catalog. AgentProxy uses the OpenAI protocol.",
  },
  "token-kiosk": {
    id: "token-kiosk",
    serviceKinds: ["llm"],
  ...
  sumopod: {
    ...
    apiHint:
      "SumoPod exposes an OpenAI-compatible chat completions endpoint at https://ai.sumopod.com/v1/chat/completions, plus a live /v1/models catalog. AgentProxy uses the OpenAI protocol and lists models via passthrough.",
  },
  x5lab: {
    id: "x5lab",
    serviceKinds: ["llm"],
    ...
    apiHint:
      "X5Lab exposes an OpenAI-compatible chat completions endpoint at https://api.x5lab.dev/v1/chat/completions, plus a live /v1/models catalog. AgentProxy uses the OpenAI protocol and lists models via passthrough.",
  },
  chenzk: {
    id: "chenzk",
    serviceKinds: ["llm"],
  ...
  kenari: {
    ...
    apiHint:
      "Kenari exposes an OpenAI-compatible chat completions endpoint at https://kenari.id/v1/chat/completions, plus a live /v1/models catalog covering Claude, GPT, DeepSeek, GLM, Kimi and more. AgentProxy uses the OpenAI protocol and lists models via passthrough.",
  },
  navy: {
    id: "navy",
    serviceKinds: ["llm"],
  ...
  ainative: {
    ...
    apiHint:
      "OpenAI-compatible endpoint at https://api.ainative.studio/api/v1 with a public /models catalog (84 models). AgentProxy lists models via passthrough.",
  },
  aion: {
    id: "aion",
    serviceKinds: ["llm"],
  ...
  seekai: {
    ...
    hasFree: true,
    freeNote:
      "Signup credit toward available models; amount and eligibility are set by SeekAi, not AgentProxy.",
