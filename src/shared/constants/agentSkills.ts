...
export const CURATED_SKILLS: CuratedSkillEntry[] = [
...

  {
    ...
    name: "Authentication",
    description:
      "Manage API key authentication and session tokens. Start here to authenticate requests via Bearer token, obtain session cookies, and configure login requirements for the AgentProxy API.",
    category: "api",
    area: "auth",
    icon: "lock",
    isEntry: true,
  },
  {
    ...
    name: "Providers",
    description:
      "Manage provider connections, API keys, OAuth flows, and connection tests via the REST API. List, add, update, remove, and test AI provider integrations across AgentProxy's 327-provider catalog.",
    category: "api",
    area: "providers",
    icon: "key",
  },
  ...
  },
  {
    ...
    name: "API Keys",
    description:
      "Create, list, rotate, and revoke AgentProxy API keys. Control per-key scopes, spending limits, and expiration. Keys gate access to all proxy and management endpoints.",
    category: "api",
    area: "api-keys",
    icon: "vpn_key",
  },
  ...
  },
  {
    ...
    name: "CLI Tools",
    description:
      "Manage CLI tool integrations exposed via the API. List, configure, and invoke CLI tool plugins that extend AgentProxy's automation surface.",
    category: "api",
    area: "cli-tools",
    icon: "terminal",
  },
  {
    ...
    name: "Tunnels",
    description:
      "Create and manage secure tunnels (ngrok, Cloudflare Tunnel, custom) to expose AgentProxy to the internet or share access with remote agents and CI pipelines.",
    category: "api",
    area: "tunnels",
    icon: "vpn_lock",
  },
  {
    ...
    name: "Cloud Sync",
    description:
      "Synchronise AgentProxy configuration, provider connections, and settings to/from cloud storage. Manage cloud worker authentication and remote backup targets.",
    category: "api",
    area: "sync-cloud",
    icon: "cloud_sync",
  },
  ...
  },
  {
    ...
    description:
      "Interact with AgentProxy via JSON-RPC 2.0 agent-to-agent protocol. 6 built-in A2A skills: smart-routing, quota-management, provider-discovery, cost-analysis, health-report, list-capabilities.",
    category: "api",
    area: "agents-a2a",
    icon: "device_hub",
  },
  ...
  },
  {
    ...
    name: "CLI: Chat",
    description:
      "Send chat completions, stream responses, and start an interactive REPL session from the CLI. Supports all AgentProxy providers, combo routing, and system prompt configuration.",
    category: "cli",
    area: "cli-chat",
    icon: "chat",
  },
  ...
  },
  {
    ...
    description:
      "Interact with the AgentProxy A2A server from the CLI. Send tasks, inspect skill execution history, and test the JSON-RPC 2.0 agent-to-agent protocol interactively.",
    category: "cli",
    area: "cli-a2a",
    icon: "device_hub",
  },
  ...
  },
  {
    ...
    description:
      "Detect installed CLI coding tools (Claude Code, Codex, Cursor, Copilot, Cline and more), search GitHub for matching agent skills, and install them to the detected tools via AgentProxy's built-in APIs.",
    category: "cli",
    area: "cli-setup",
    icon: "extension",
  },
...

  {
    ...
    description:
      "Step-by-step agent workflow to configure the OpenAI Codex CLI on any machine (Linux, macOS, Windows) to use AgentProxy as an OpenAI-compatible backend. Detects OS and shell, writes config.toml and 7 named profiles, sets environment variables, and verifies the setup.",
    category: "config",
