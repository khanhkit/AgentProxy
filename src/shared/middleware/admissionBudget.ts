 ...
 * the hot path. `override` defaults to `AGENTPROXY_CHAT_MAX_INFLIGHT_BYTES`.
 */
export function resolveIngestByteBudget(
  override: string | number | null | undefined = process.env.AGENTPROXY_CHAT_MAX_INFLIGHT_BYTES
): IngestBudget {
