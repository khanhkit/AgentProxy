...
const footerLinks = {
  product: [
    ...
    {
      key: "changelog",
      href: "https://github.com/khanhkit/AgentProxy/releases",
      external: true,
    },
  ],
  resources: [
    ...
    {
      key: "helpCenter",
      href: "https://github.com/khanhkit/AgentProxy/discussions",
      external: true,
    },
  ],
  company: [
    { key: "about", href: "https://github.com/khanhkit/AgentProxy", external: true },
    { key: "blog", href: "https://github.com/khanhkit/AgentProxy/releases", external: true },
    {
      key: "contact",
      href: "https://github.com/khanhkit/AgentProxy/issues/new/choose",
      external: true,
    },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://github.com/khanhkit/AgentProxy"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-primary transition-colors"
                aria-label="GitHub"
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm text-text-muted">
            ...
            <a
              href="https://github.com/khanhkit/AgentProxy/blob/main/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors"
            >
