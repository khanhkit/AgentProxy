...
export const OPENAPI_TITLE = "AgentProxy API";
...
export const OPENAPI_ENDPOINTS: OpenApiEndpoint[] = [
  ...
  {
    path: "/api/v1/{agentproxyCatchAll}",
    method: "DELETE",
    summary: "DELETE <agentproxyCatchAll>",
    description: "",
    tag: "V1 AgentProxyCatchAll",
    tags: ["V1 AgentProxyCatchAll"],
    requiresAuth: false,
    hasRequestBody: false,
  },
  {
    path: "/api/v1/{agentproxyCatchAll}",
    method: "GET",
    summary: "GET <agentproxyCatchAll>",
    description: "",
    tag: "V1 AgentProxyCatchAll",
    tags: ["V1 AgentProxyCatchAll"],
    requiresAuth: false,
  ...
  },
  {
    path: "/api/v1/{agentproxyCatchAll}",
    method: "PATCH",
    summary: "PATCH <agentproxyCatchAll>",
    description: "",
    tag: "V1 AgentProxyCatchAll",
    tags: ["V1 AgentProxyCatchAll"],
    requiresAuth: false,
  ...
  },
  {
    path: "/api/v1/{agentproxyCatchAll}",
    method: "POST",
    summary: "POST <agentproxyCatchAll>",
    description: "",
    tag: "V1 AgentProxyCatchAll",
    tags: ["V1 AgentProxyCatchAll"],
    requiresAuth: false,
  ...
  },
  {
    path: "/api/v1/{agentproxyCatchAll}",
    method: "PUT",
    summary: "PUT <agentproxyCatchAll>",
    description: "",
    tag: "V1 AgentProxyCatchAll",
    tags: ["V1 AgentProxyCatchAll"],
    requiresAuth: false,
  ...
  },
  {
    ...
    description: "OpenAI Whisper–compatible audio translation (multipart/form-data). Unlike `/api/v1/audio/transcriptions`, output is always English regardless of the source language. Success responses carry the `X-AgentProxy-*` cost-telemetry headers.",
    tag: "Audio",
    tags: ["Audio"],
    requiresAuth: true,
    hasRequestBody: true,
