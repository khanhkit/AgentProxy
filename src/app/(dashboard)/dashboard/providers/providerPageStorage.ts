export const SHOW_CONFIGURED_ONLY_STORAGE_KEY = "agentproxy-providers-show-configured-only";
export const PROVIDER_DISPLAY_MODE_STORAGE_KEY = "agentproxy-providers-display-mode";
