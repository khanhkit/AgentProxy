        ...
        <div className="p-5">
          ...
          <p className="mt-1 text-sm text-text-muted">
            {L(
              ...
              "Scoped tokens that let the agentproxy CLI manage this server remotely. Distinct from inference API keys. The secret is shown once. Automation guide: /docs/guides/MANAGEMENT-AUTH."
            )}
          </p>
        </div>
      </Card>
