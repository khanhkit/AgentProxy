...
const CODEX_KEY = "AGENTPROXY_AUTO_SYNC_CODEX_PROFILES";
const CLAUDE_KEY = "AGENTPROXY_AUTO_SYNC_CLAUDE_PROFILES";
 ...
 * Reads/writes the AGENTPROXY_AUTO_SYNC_{CODEX,CLAUDE}_PROFILES feature flags via
