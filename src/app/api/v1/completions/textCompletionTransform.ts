/**
 * #3571 — `/v1/completions` is the legacy OpenAI Completions API. AgentProxy routes
 ...
 * the model they asked for, and the `x-agentproxy-model` response header
 ...
 * requested identifier (matching the `x-agentproxy-model` response header).
 */
