...
import { generateProviderPluginManifest } from "@agentproxy/open-sse/config/providerPluginManifestRegistry.ts";
...
import type {
  ...
  ProviderPluginModel,
} from "@agentproxy/open-sse/config/providerPluginManifest.ts";
