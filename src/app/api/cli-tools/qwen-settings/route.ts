...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    return NextResponse.json({
      ...runtime,
      settings,
      hasAgentProxy: hasAgentProxyQwenCodeConfig(settings),
...
export async function POST(request: Request): Promise<Response> {
  ...
  try {
    ...
    if (!apiKey) apiKey = "sk_agentproxy";
    ...
    return NextResponse.json({
      success: true,
      message: "Qwen Code now routes through AgentProxy",
      settingsPath: configPaths.settings,
      envPath: configPaths.env,
    });
  } catch (error) {
...
export async function DELETE(request: Request): Promise<Response> {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "AgentProxy settings removed from Qwen Code",
    });
  } catch (error) {
