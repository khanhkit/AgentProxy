...
export const REDIS_CONTAINER_NAME = process.env.AGENTPROXY_REDIS_CONTAINER_NAME || "agentproxy-redis";
...
// AGENTPROXY_REDIS_BIND_HOST and secure the instance themselves.
