...
async function rebuildHealthPayload(): Promise<unknown> {
  ...
  const [
    ...
    import("@agentproxy/open-sse/services/rateLimitManager"),
    import("@agentproxy/open-sse/services/accountFallback"),
    import("@agentproxy/open-sse/services/requestDedup.ts"),
    import("@agentproxy/open-sse/services/quotaMonitor.ts"),
    import("@agentproxy/open-sse/services/sessionManager.ts"),
    import("@/lib/credentialHealth/cache"),
    import("@/lib/localHealthCheck"),
    import("@agentproxy/open-sse/services/admission/runtime.ts"),
