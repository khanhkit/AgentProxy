 ...
 * Uses AgentProxy's skill registry + CLI tool paths (no Skill Collector bridge).
 *
 * Body: {
...
import { sanitizeErrorMessage, buildErrorBody } from "@agentproxy/open-sse/utils/error";
