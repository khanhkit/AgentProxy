...
import { sanitizeErrorMessage, buildErrorBody } from "@agentproxy/open-sse/utils/error.ts";
 ...
 *
 * AgentProxy Copilot chat endpoint.
 * Accepts user messages about AgentProxy configuration and returns
