...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-agentproxy-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-agentproxy-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-agentproxy-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-agentproxy-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-agentproxy-auth-scopes";
 ...
 * token matches this process's AGENTPROXY_PEER_STAMP_TOKEN (see
 ...
 * proxy hop (e.g. AgentProxy behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-agentproxy-peer-locality";
 ...
 */
export const AUTHZ_HEADER_TRUSTED_PEER_IP = "x-agentproxy-trusted-peer-ip";
