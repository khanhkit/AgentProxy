...
import { buildAutoCandidates } from "@agentproxy/open-sse/services/combo.ts";
import { parseAutoConfig } from "@agentproxy/open-sse/services/combo/autoConfig.ts";
import { resolveComboTargets } from "@agentproxy/open-sse/services/combo/comboStructure.ts";
import { evaluateAutoCandidates } from "@agentproxy/open-sse/services/combo/resolveAutoStrategy.ts";
import type { AutoProviderCandidate, ComboLike } from "@agentproxy/open-sse/services/combo/types.ts";
import {
  calculateFactors,
  calculateScore,
  DEFAULT_WEIGHTS,
  ...
  type ScoringWeights,
  validateWeights,
} from "@agentproxy/open-sse/services/autoCombo/scoring.ts";
import { getModePack } from "@agentproxy/open-sse/services/autoCombo/modePacks.ts";
import { getTaskFitness } from "@agentproxy/open-sse/services/autoCombo/taskFitness.ts";
import type {
  ComboAutopilotCombo,
