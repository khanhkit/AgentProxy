 ...
 * trace out of AgentProxy into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The AgentProxy capture source
...
const CREATOR_NAME = "AgentProxy Traffic Inspector";
