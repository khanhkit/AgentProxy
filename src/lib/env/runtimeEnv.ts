...
export const webRuntimeEnvSchema = z.object({
  ...
  AGENTPROXY_DISABLE_BACKGROUND_SERVICES: optionalBooleanEnv,
  CLOUD_URL: optionalHttpUrl,
  NEXT_PUBLIC_CLOUD_URL: optionalHttpUrl,
  AGENTPROXY_PUBLIC_BASE_URL: optionalHttpUrl,
  AGENTPROXY_BASE_URL: optionalHttpUrl,
  ...
  AGENTPROXY_PORT: optionalPortEnv,
