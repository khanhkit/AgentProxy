...
function isAutoSyncEnabled() {
  // Opt-in, default OFF. Backed by the AGENTPROXY_AUTO_SYNC_CODEX_PROFILES feature flag
  ...
  return isFeatureFlagEnabled("AGENTPROXY_AUTO_SYNC_CODEX_PROFILES");
}
...
export async function autoSyncCodexProfilesFromLiveCatalog(
  ...
  // Reuse the CLI generator so automatic sync and `agentproxy setup-codex`
