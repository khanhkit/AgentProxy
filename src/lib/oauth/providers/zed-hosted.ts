...
} from "@agentproxy/open-sse/shared/zedAuth.ts";
 ...
 * native_app_port so the redirect lands back on AgentProxy (auto-completed via
 ...
 * on AgentProxy itself. Zed always redirects to `http://127.0.0.1:<native_app_port>/`
 ...
 * differ from what the AgentProxy Node process actually listens on (e.g. a local
 ...
 * (`getRuntimePorts()`, sourced from AGENTPROXY_PORT/PORT/DASHBOARD_PORT) instead
