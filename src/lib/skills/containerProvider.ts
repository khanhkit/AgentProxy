/**
 * Container runtime providers for the AgentProxy skill sandbox.
 *
 * The sandbox historically hardcoded the `docker` CLI. This module abstracts
 * the container runtime so AgentProxy can pick the most performant / native
...
const SANDBOX_NAME = (sandboxId: string) => `agentproxy-${sandboxId}`;
