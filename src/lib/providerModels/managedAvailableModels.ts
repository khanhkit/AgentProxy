...
// Prune pass (#11836): only alias names AgentProxy itself generated/adopted
...
// Assigns (or adopts) the alias for one visible model. Only an alias AgentProxy itself
...
export async function syncManagedAvailableModelAliases(
  ...
  const state: AliasSyncState = {
    ...
    // Provenance marker (#11836): only alias names AgentProxy itself generated/adopted are
