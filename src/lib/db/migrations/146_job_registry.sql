...
CREATE TABLE IF NOT EXISTS jobs (
  ...
  env_flag TEXT,                             -- env var name (boolean gate), e.g. 'AGENTPROXY_WARMUP_ENABLED'; NULL = no gate
...
INSERT OR IGNORE INTO jobs (id, type, cron, interval_ms, enabled, env_flag, config) VALUES
  ...
  ('warmup', 'cron', '0 7 * * *', NULL, 0, 'AGENTPROXY_WARMUP_ENABLED', '{"timezone":"America/Los_Angeles","envDefault":false}'),
