...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'agentproxy'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with AgentProxy
...
-- Determines whether each provider uses AgentProxy's native executor,
