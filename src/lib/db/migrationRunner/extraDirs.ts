 ...
 * space: `NNN_name.sql` is recorded in `_agentproxy_migrations` as `NNN`. That
 ...
 * namespace:
 *
 *   AGENTPROXY_EXTRA_MIGRATIONS_DIRS="ee=/opt/app/enterprise/db/migrations"
 *
...
export const EXTRA_MIGRATIONS_DIRS_ENV = "AGENTPROXY_EXTRA_MIGRATIONS_DIRS";
