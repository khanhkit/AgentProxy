...
const HEADER_NAME = "x-agentproxy-cli-token";
...
/**
 * Validates the CLI machine-id token sent by the local agentproxy CLI.
 * Only accepted from loopback IPs. Disabled via AGENTPROXY_DISABLE_CLI_TOKEN=true.
 */
