/**
 * MCP Tool Schemas — Contracts for the canonical AgentProxy MCP tools.
 *
 ...
 *
 * Each tool wraps existing AgentProxy API endpoints and exposes them through
...
// --- Tool 3: agentproxy_get_combo_metrics ---
...
> = {
  name: "agentproxy_get_combo_metrics",
  description:
...
// --- Tool 4: agentproxy_switch_combo ---
...
// --- Tool 4b: agentproxy_create_combo ---
...
// --- Tool 6: agentproxy_route_request ---
...
> = {
  ...
  description:
    "Sends a chat completion request through AgentProxy's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 8: agentproxy_list_models_catalog ---
...
> = {
  name: "agentproxy_list_models_catalog",
  description:
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  ...
  description:
    "Performs a web search using AgentProxy's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, AnySearch, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data. Not X/Twitter — use agentproxy_x_search for that.",
...
export const xSearchTool: McpToolDefinition<typeof xSearchInput, typeof webSearchOutput> = {
  ...
  description:
    "Search X (Twitter) through AgentProxy. Uses SuperGrok / xAI server-side x_search by default, or Xquik when provider is xquik-search. Requires credentials for the selected backend. This is not web search.",
...
export const webFetchTool: McpToolDefinition<typeof webFetchInput, typeof webFetchOutput> = {
  name: "agentproxy_web_fetch",
  description:
    "Fetches and extracts content from a URL using AgentProxy's web fetch gateway. Supports multiple providers (Firecrawl, Jina Reader, Tavily, TinyFish, Context7 library docs) with automatic failover. Returns the page content as markdown, HTML, links, or screenshot, along with metadata.",
...
// --- Tool 9: agentproxy_simulate_route ---
...
// --- Tool 10: agentproxy_set_budget_guard ---
...
> = {
  name: "agentproxy_set_budget_guard",
  description:
...
// --- Tool 11: agentproxy_set_routing_strategy ---
...
> = {
  name: "agentproxy_set_routing_strategy",
  description:
...
// --- Tool 12: agentproxy_set_resilience_profile ---
...
> = {
  name: "agentproxy_set_resilience_profile",
  description:
...
// --- Tool 14: agentproxy_get_provider_metrics ---
...
> = {
  name: "agentproxy_get_provider_metrics",
  description:
...
// --- Tool 15: agentproxy_best_combo_for_task ---
...
> = {
  name: "agentproxy_best_combo_for_task",
  description:
...
// --- Tool 16: agentproxy_explain_route ---
...
// --- Tool 17: agentproxy_get_session_snapshot ---
...
> = {
  name: "agentproxy_get_session_snapshot",
  description:
...
// --- Tool 18: agentproxy_db_health_check ---
...
> = {
  name: "agentproxy_db_health_check",
  description:
    "Diagnoses AgentProxy database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
// --- Tool 19: agentproxy_sync_pricing ---
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "agentproxy_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into AgentProxy. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
> = {
  name: "agentproxy_compression_status",
  description:
...
> = {
  name: "agentproxy_compression_configure",
  description:
...
> = {
  name: "agentproxy_set_compression_engine",
...
> = {
  name: "agentproxy_list_compression_combos",
...
> = {
  name: "agentproxy_compression_combo_stats",
...
> = {
  name: "agentproxy_oneproxy_fetch",
  description:
...
> = {
  name: "agentproxy_oneproxy_rotate",
  description:
...
> = {
  name: "agentproxy_oneproxy_stats",
  description:
