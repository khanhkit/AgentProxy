/**
 * AgentProxy MCP Session Pool Tools — Manage and monitor anonymous web session pools.
 *
 * Tools:
 *   1. agentproxy_pool_status   — Get pool stats for one or all providers
 *   2. agentproxy_pool_sessions — List per-session details for a provider's pool
 *   3. agentproxy_pool_reset    — Shut down and recreate a pool
 *   4. agentproxy_pool_warm     — Warm up a pool to a target session count
 *   5. agentproxy_pool_health   — Aggregated pool health with breaker state and issues
 */
...
export const poolTools = {
  agentproxy_pool_status: {
    name: "agentproxy_pool_status",
    description:
  ...
  agentproxy_pool_sessions: {
    name: "agentproxy_pool_sessions",
    description:
  ...
  agentproxy_pool_reset: {
    name: "agentproxy_pool_reset",
    description:
  ...
  agentproxy_pool_warm: {
    name: "agentproxy_pool_warm",
    description:
  ...
  agentproxy_pool_health: {
    name: "agentproxy_pool_health",
    description:
  ...
  agentproxy_browser_pool_status: {
    name: "agentproxy_browser_pool_status",
    description:
