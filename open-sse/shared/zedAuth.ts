 ...
 *
 *   1. The client (AgentProxy) generates an ephemeral RSA keypair.
 ...
 *   5. AgentProxy decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + AgentProxy conventions. `fetch` is intentionally the
