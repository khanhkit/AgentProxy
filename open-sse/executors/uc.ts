 ...
 * OpenAI-compatible AgentProxy provider.
 *
 ...
 * client and the ambient patched `fetch` (token mint); AgentProxy's per-connection
...
export class UcExecutor extends BaseExecutor {
   ...
   * message returned AS the answer) is surfaced as a retryable 502 so AgentProxy
