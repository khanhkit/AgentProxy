 ...
 * into the signature proof). AgentProxy stores these in the connection's
 * `providerSpecificData` (minted by AgentProxy's own browser-mint flow — see
 ...
 * is how AgentProxy threads the stored connection token). Returns null when not
