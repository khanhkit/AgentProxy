 ...
 * Firefox-TLS client (wreq-js firefox_150, the AgentProxy egress overlay) passes the
 * TLS gate, so AgentProxy mints fresh access tokens itself with no browser.
 *
