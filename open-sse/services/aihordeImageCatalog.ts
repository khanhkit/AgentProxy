...
export const AI_HORDE_CLIENT_AGENT = "AgentProxy:3.8.49:https://github.com/khanhkit/AgentProxy";
export const AI_HORDE_CATALOG_POLL_MS = 30_000;
// The catalog endpoint is a fixed, trusted AgentProxy-controlled URL (not
