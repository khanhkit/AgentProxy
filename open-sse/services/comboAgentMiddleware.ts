 ...
 * The tag is an internal AgentProxy marker; providers must never see it or their
...
export function applyComboAgentMiddleware(
  ...
  //    These tags are AgentProxy-internal markers and must never reach the provider
