 ...
 * not reliable here because AgentProxy may force a streaming envelope internally.
 */
 ...
 *
 * Supports BOTH wire formats AgentProxy may emit:
 ...
 * `x-agentproxy-chaos-error` header and an error final chunk (status stays 200
