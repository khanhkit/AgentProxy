 ...
 * (Anthropic's current model migration guidance). AgentProxy can still produce a manual
 ...
 * This contract is verified for AgentProxy's two direct Anthropic API providers:
