 ...
 * AgentProxy keeps the holdback OFF by default (see ResilienceSettings.streamRecovery)
...
// Terminal SSE markers AgentProxy emits across formats: OpenAI `data: [DONE]`,
...
export function createRecoverableStream(
  ...
  // out of scope for this fix, which targets the observed opencode/AgentProxy pairing where the
