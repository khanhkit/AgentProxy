 ...
 *
 * Unlike AgentProxy's local compression engines (which rewrite the request body
 ...
 * context-management-2025-06-27` header, which AgentProxy already emits on Claude
