...
// local `droid` CLI. AgentProxy already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through AgentProxy.
//
...
// back to stored CLI credentials only when omitted. AgentProxy does NOT read
