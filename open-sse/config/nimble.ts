 ...
 * in AgentProxy — search (`POST /v1/search`, wired in open-sse/handlers/search.ts)
...
/** The value AgentProxy sends. Do not vary it per surface or per request. */
export const NIMBLE_CLIENT_SOURCE = "agentproxy";
