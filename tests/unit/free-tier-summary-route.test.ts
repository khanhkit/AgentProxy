...
import { FREE_CATALOG_CURATED_AT } from "@agentproxy/open-sse/config/freeModelCatalog.data.ts";

process.env.DATA_DIR = mkdtempSync(join(tmpdir(), "agentproxy-freetier-route-"));
