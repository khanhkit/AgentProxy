...
const BIN_ENTRY = path.join(ROOT, "bin", "agentproxy.mjs");
...
test("every bin/agentproxy.mjs local import is enforced by check:pack-artifact", () => {
  // The CLI boot path (bin/agentproxy.mjs → bin/cli/*) is covered by allowlist PREFIXES,
