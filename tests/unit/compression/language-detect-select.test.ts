...
import { detectCompressionLanguage } from "@agentproxy/open-sse/services/compression/languageDetector.ts";
import { cavemanCompress } from "@agentproxy/open-sse/services/compression/caveman.ts";
