...
// Regression guard for #3883: the @agentproxy/opencode-plugin must ship an
...
const PKG_URL = new URL("../../../@agentproxy/opencode-plugin/package.json", import.meta.url);
const TSUP_URL = new URL("../../../@agentproxy/opencode-plugin/tsup.config.ts", import.meta.url);
