...
describe("bin/agentproxy.mjs MCP path handling", () => {
  it("pathToFileURL converts Windows paths to valid file:// URLs", () => {
    ...
    const testPath = "C:\\Users\\test\\projects\\AgentProxy\\bin\\mcp-server.mjs";
  ...
  it("pathToFileURL converts Unix paths to valid file:// URLs", () => {
    ...
    const testPath = "/home/user/projects/AgentProxy/bin/mcp-server.mjs";
    const fileUrl = pathToFileURL(testPath);
