 ...
 * spawned with a FIXED 512MB heap default (`agentproxy serve`) or with no
 ...
 * ceiling scales with the machine. An explicit `AGENTPROXY_MEMORY_MB` still wins
...
test("#5172 an explicit AGENTPROXY_MEMORY_MB still wins over the calibrated default", () => {
