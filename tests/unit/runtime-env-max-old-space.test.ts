 ...
 * AGENTPROXY_MEMORY_MB instead of relying only on the image-level NODE_OPTIONS
 ...
 * uses (mirroring `agentproxy serve`): AGENTPROXY_MEMORY_MB clamped to [64, 16384],
 * default 512.
 */
...
test("#2939 honors a valid AGENTPROXY_MEMORY_MB (string or number)", () => {
