...
describe("ProviderPageHeader — Kimi partner-link note", () => {
  ...
  it.each([
    ...
    ["kimi-coding", "Kimi Code CLI", "https://www.kimi.com/code"],
    ...
    expect(link?.getAttribute("aria-label")).toBe(
      `${name} — Partner link — supports AgentProxy at no extra cost to you`
    );
    expect(el.textContent).toContain("Partner link — supports AgentProxy at no extra cost to you");
  });
