 ...
 *     AgentProxy self-loop, Google's Gemini OpenAI-compat endpoint).
...
test("#2232 — AgentProxy-internal providers default to self-loop when no env vars set", () => {
  clearEnv();
  // Non-standard prefixes (kr/, if/, pol/, groq/) should use AgentProxy self-loop
