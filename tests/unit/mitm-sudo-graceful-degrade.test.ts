 ...
 *
 * AgentProxy's runtime Docker image (`Dockerfile`) runs as `USER node` (UID 1000)
 ...
 *
 * This mirrors upstream behavior (decolua/9router) extended to AgentProxy's TS
 * fork and AgentProxy's existing root-detection (`isRoot()`).
 */
