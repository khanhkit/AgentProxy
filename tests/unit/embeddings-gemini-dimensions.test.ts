...
process.env.DATA_DIR = mkdtempSync(join(tmpdir(), "agentproxy-embeddings-gemini-dim-"));
...
// so AgentProxy must forward `outputDimensionality` alongside `dimensions` for Gemini
