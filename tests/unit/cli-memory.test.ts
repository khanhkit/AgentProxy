/**
 * Tests for CLI Memory Sanitization (bin/agentproxy.mjs)
 *
 * Tests cover:
...
describe("CLI Memory Limit Sanitization", () => {
  /**
   * Replicate the memory sanitization logic from bin/agentproxy.mjs
   */
...
describe("CLI .env File Loading", () => {
  /**
   * Simulate the .env parsing logic from bin/agentproxy.mjs
   */
