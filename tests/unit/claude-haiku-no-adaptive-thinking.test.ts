...
import { normalizeClaudeHaikuConstraints } from "@agentproxy/open-sse/services/claudeHaikuConstraints.ts";
...
// Several AgentProxy paths can still emit these on Haiku targets:
