import type { AgentProxyEnrichmentMap } from "./enrich.js";
import type { AgentProxyRawCombo } from "./combos-map.js";
 ...
 */
export function isUsableCombo(combo: AgentProxyRawCombo, usable: UsableProviderSet): boolean {
