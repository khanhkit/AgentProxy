 ...
 * pricing + free-tier budgets) from a running AgentProxy instance.
 */
/**
 ...
 */
export type AgentProxyEnrichmentSourceError = (endpoint: string, reason: string) => void;

export type AgentProxyEnrichmentFetcher = (
  baseURL: string,
  apiKey: string,
  timeoutMs?: number,
  onSourceError?: AgentProxyEnrichmentSourceError
