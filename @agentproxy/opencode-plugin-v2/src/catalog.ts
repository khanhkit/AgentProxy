 ...
 */
function synthesizeNestedMember(name: string, nested: LegacyModelV2): AgentProxyRawModelEntry {
...
export async function publishCatalog(
  ...
  log.debug(`[agentproxy-v2] host catalog contract detected: ${hostContract}`);
